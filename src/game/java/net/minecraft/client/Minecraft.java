...
public class Minecraft implements Runnable {
	...
	public void startGame() throws LWJGLException {
		...
		ColorizerWater
				.setWaterBiomeColorizer(this.renderEngine.getTextureContents("/misc/watercolor.png"));
		ColorizerGrass
				.setGrassBiomeColorizer(this.renderEngine.getTextureContents("/misc/grasscolor.png"));
		ColorizerFoliage
				.getFoilageBiomeColorizer(this.renderEngine.getTextureContents("/misc/foliagecolor.png"));
	...
	private void runGameLoop() {
		...
		for (this.isGamePaused = !this.isMultiplayerWorld() && this.currentScreen != null
				&& this.currentScreen.doesGuiPauseGame(); System
						.currentTimeMillis() >= this.debugUpdateTime + 1000L; this.fpsCounter = 0) {
	...
	private void displayDebugInfo(long var1) {
		...
		for (int var14 = 0; var14 < frameTimes.length; ++var14) {
			...
			var9.addVertex((double) ((float) var14 + 0.5F), (double) ((float) ((long) this.displayHeight - var18) + 0.5F),
					0.0D);
			...
			var9.addVertex((double) ((float) var14 + 0.5F), (double) ((float) ((long) this.displayHeight - var18) + 0.5F),
					0.0D);
			var9.addVertex((double) ((float) var14 + 0.5F),
					(double) ((float) ((long) this.displayHeight - (var18 - var20)) + 0.5F), 0.0D);
		}
	...
	public void runTick() {
				...
				while (true) {
					do {
						if (!Keyboard.next()) {
							...
							if (this.currentScreen == null
									&& (Keyboard.isKeyDown(Keyboard.KEY_SLASH) || Keyboard.isKeyDown(Keyboard.KEY_DIVIDE))) {
								this.displayGuiScreen(new GuiChat("/"));
							}
		...
		if (this.theWorld != null) {
			...
			if (!this.isGamePaused && this.theWorld != null) {
				this.theWorld.randomDisplayUpdates(MathHelper.floor_double(this.thePlayer.posX),
	...
	public void usePortal(int var1) {
		...
		if (this.thePlayer.dimension == -1) {
			this.thePlayer.setLocationAndAngles(var3, this.thePlayer.posY, var5, this.thePlayer.rotationYaw,
					this.thePlayer.rotationPitch);
	...
	public void respawn(boolean var1, int var2, boolean var3) {
		...
		if (var6) {
			...
			this.thePlayer.setLocationAndAngles((double) ((float) var5.posX + 0.5F), (double) ((float) var5.posY + 0.1F),
					(double) ((float) var5.posZ + 0.5F), 0.0F, 0.0F);
		}
	...
	private void clickMiddleMouseButton() {
		if (this.objectMouseOver != null) {
			...
			int var2 = this.theWorld.getBlockId(this.objectMouseOver.blockX, this.objectMouseOver.blockY,
			...
			if (Item.itemsList[var2] != null && Item.itemsList[var2].getHasSubtypes()) {
				var3 = this.theWorld.getBlockMetadata(this.objectMouseOver.blockX, this.objectMouseOver.blockY,
						this.objectMouseOver.blockZ);
				var4 = true;
			}
			...
			if (var1) {
				...
				this.playerController
						.sendSlotPacket(this.thePlayer.inventory.getStackInSlot(this.thePlayer.inventory.currentItem), var7);
			}
		}
