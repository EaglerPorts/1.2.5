...
public class ComponentNetherBridgeCrossing2 extends ComponentNetherBridgePiece {
	...
	public static ComponentNetherBridgeCrossing2 createValidComponent(List var0, Random var1, int var2, int var3,
		...
		return isAboveGround(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentNetherBridgeCrossing2(var6, var1, var7, var5)
				: null;
	}
