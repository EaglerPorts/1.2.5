...
public abstract class StructureComponent {
	...
	protected int getMetadataWithOffset(int var1, int var2) {
		if (var1 == Block.rail.blockID) {
			...
			if (var1 != Block.stairCompactCobblestone.blockID && var1 != Block.stairCompactPlanks.blockID
					&& var1 != Block.stairsNetherBrick.blockID && var1 != Block.stairsStoneBrickSmooth.blockID) {
	...
	protected void placeBlockAtCurrentPosition(World var1, int var2, int var3, int var4, int var5, int var6,
	...
	protected void fillWithBlocks(World var1, StructureBoundingBox var2, int var3, int var4, int var5, int var6, int var7,
	...
	protected void fillWithRandomizedBlocks(World var1, StructureBoundingBox var2, int var3, int var4, int var5, int var6,
			int var7, int var8, boolean var9, Random var10, StructurePieceBlockSelector var11) {
		for (int var12 = var4; var12 <= var7; ++var12) {
			for (int var13 = var3; var13 <= var6; ++var13) {
				for (int var14 = var5; var14 <= var8; ++var14) {
					if (!var9 || this.getBlockIdAtCurrentPosition(var1, var13, var12, var14, var2) != 0) {
						var11.selectBlocks(var10, var13, var12, var14,
								var12 == var4 || var12 == var7 || var13 == var3 || var13 == var6 || var14 == var5 || var14 == var8);
						this.placeBlockAtCurrentPosition(var1, var11.getSelectedBlockId(), var11.getSelectedBlockMetaData(), var13,
								var12, var14, var2);
					}
				}
			}
	...
	protected void randomlyFillWithBlocks(World var1, StructureBoundingBox var2, Random var3, float var4, int var5,
			int var6, int var7, int var8, int var9, int var10, int var11, int var12, boolean var13) {
			...
			for (int var15 = var5; var15 <= var8; ++var15) {
				for (int var16 = var7; var16 <= var10; ++var16) {
					if (var3.nextFloat() <= var4
							&& (!var13 || this.getBlockIdAtCurrentPosition(var1, var15, var14, var16, var2) != 0)) {
	...
	protected void randomlyPlaceBlock(World var1, StructureBoundingBox var2, Random var3, float var4, int var5, int var6,
	...
	protected void randomlyRareFillWithBlocks(World var1, StructureBoundingBox var2, int var3, int var4, int var5,
			int var6, int var7, int var8, int var9, boolean var10) {
	...
	protected void clearCurrentPositionBlocksUpwards(World var1, int var2, int var3, int var4,
	...
	protected void fillCurrentPositionBlocksDownwards(World var1, int var2, int var3, int var4, int var5, int var6,
			StructureBoundingBox var7) {
		int var8 = this.getXWithOffset(var4, var6);
		int var9 = this.getYWithOffset(var5);
		int var10 = this.getZWithOffset(var4, var6);
	...
	protected void createTreasureChestAtCurrentPosition(World var1, StructureBoundingBox var2, Random var3, int var4,
			int var5, int var6, StructurePieceTreasure[] var7, int var8) {
	...
	private static void fillTreasureChestWithLoot(Random var0, StructurePieceTreasure[] var1, TileEntityChest var2,
			int var3) {
		for (int var4 = 0; var4 < var3; ++var4) {
			StructurePieceTreasure var5 = (StructurePieceTreasure) WeightedRandom.getRandomItem(var0,
					(WeightedRandomChoice[]) var1);
			...
			if (Item.itemsList[var5.itemID].getItemStackLimit() >= var6) {
				var2.setInventorySlotContents(var0.nextInt(var2.getSizeInventory()),
						new ItemStack(var5.itemID, var6, var5.itemMetadata));
			} else {
				for (int var7 = 0; var7 < var6; ++var7) {
					var2.setInventorySlotContents(var0.nextInt(var2.getSizeInventory()),
							new ItemStack(var5.itemID, 1, var5.itemMetadata));
				}
			}
		}
	...
	protected void placeDoorAtCurrentPosition(World var1, StructureBoundingBox var2, Random var3, int var4, int var5,
			int var6, int var7) {
		int var8 = this.getXWithOffset(var4, var6);
		int var9 = this.getYWithOffset(var5);
		int var10 = this.getZWithOffset(var4, var6);
