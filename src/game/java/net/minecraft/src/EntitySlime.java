...
public class EntitySlime extends EntityLiving implements IMob {
	...
	public void onUpdate() {
		...
		if (this.onGround && !var1) {
			...
			if (this.func_40134_ak()) {
				this.worldObj.playSoundAtEntity(this, this.func_40138_aj(), this.getSoundVolume(),
	...
	public void onCollideWithPlayer(EntityPlayer var1) {
		if (this.func_40137_ah()) {
			int var2 = this.getSlimeSize();
			if (this.canEntityBeSeen(var1) && (double) this.getDistanceToEntity(var1) < 0.6D * (double) var2
					&& var1.attackEntityFrom(DamageSource.causeMobDamage(this), this.func_40130_ai())) {
	...
	public boolean getCanSpawnHere() {
		...
		return (this.getSlimeSize() == 1 || this.worldObj.difficultySetting > 0) && this.rand.nextInt(10) == 0
				&& var1.getRandomWithSeed(987234911L).nextInt(10) == 0 && this.posY < 40.0D ? super.getCanSpawnHere() : false;
	}
