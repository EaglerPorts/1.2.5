...
public class BlockFire extends Block {
	...
	public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
		...
		if (var1.worldProvider instanceof WorldProviderEnd
				&& var1.getBlockId(var2, var3 - 1, var4) == Block.bedrock.blockID) {
			var6 = true;
		}
		...
		if (var6 || !var1.isRaining()
				|| !var1.canLightningStrikeAt(var2, var3, var4) && !var1.canLightningStrikeAt(var2 - 1, var3, var4)
						&& !var1.canLightningStrikeAt(var2 + 1, var3, var4) && !var1.canLightningStrikeAt(var2, var3, var4 - 1)
						&& !var1.canLightningStrikeAt(var2, var3, var4 + 1)) {
						...
						for (int var12 = var3 - 1; var12 <= var3 + 4; ++var12) {
							if (var10 != var2 || var12 != var3 || var11 != var4) {
								...
								if (var14 > 0) {
									...
									if (var15 > 0 && var5.nextInt(var13) <= var15
											&& (!var1.isRaining() || !var1.canLightningStrikeAt(var10, var12, var11))
											&& !var1.canLightningStrikeAt(var10 - 1, var12, var4)
											&& !var1.canLightningStrikeAt(var10 + 1, var12, var11)
											&& !var1.canLightningStrikeAt(var10, var12, var11 - 1)
											&& !var1.canLightningStrikeAt(var10, var12, var11 + 1)) {
	...
	public void onBlockAdded(World var1, int var2, int var3, int var4) {
		if (var1.worldProvider.worldType > 0 || var1.getBlockId(var2, var3 - 1, var4) != Block.obsidian.blockID
