...
public class ComponentVillageHouse3 extends ComponentVillage {
	...
	public static ComponentVillageHouse3 findValidPlacement(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, 0, 0, 0, 9, 7, 12,
				var5);
		return canVillageGoDeeper(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentVillageHouse3(var6, var1, var7, var5)
				: null;
	}
		...
		for (var6 = -1; var6 <= 2; ++var6) {
			for (var7 = 0; var7 <= 8; ++var7) {
				...
				if ((var6 > -1 || var7 <= 1) && (var6 > 0 || var7 <= 3) && (var6 > 1 || var7 <= 4 || var7 >= 6)) {
					this.placeBlockAtCurrentPosition(var1, Block.stairCompactPlanks.blockID, var5, var7, 4 + var6, 5 - var6,
							var3);
				}
			}
		}
