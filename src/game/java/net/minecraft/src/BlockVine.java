...
public class BlockVine extends Block {
	...
	private boolean canVineStay(World var1, int var2, int var3, int var4) {
		...
		if (var5 > 0) {
			for (int var7 = 0; var7 <= 3; ++var7) {
				...
				if ((var5 & var8) != 0
						&& !this
								.canBePlacedOn(var1.getBlockId(var2 + Direction.offsetX[var7], var3, var4 + Direction.offsetZ[var7]))
			...
			if (var10 == 1 && var3 < 255 && var1.isAirBlock(var2, var3 + 1, var4)) {
				...
				if (var12 > 0) {
					for (var13 = 0; var13 <= 3; ++var13) {
						if (!this.canBePlacedOn(
								var1.getBlockId(var2 + Direction.offsetX[var13], var3 + 1, var4 + Direction.offsetZ[var13]))) {
							var12 &= ~(1 << var13);
						}
					}
				...
				if (var10 >= 2 && var10 <= 5 && (var9 & 1 << var11) == 0) {
					...
					if (var12 != 0 && Block.blocksList[var12] != null) {
						...
						var14 = var11 + 3 & 3;
						if ((var9 & 1 << var13) != 0
								&& this.canBePlacedOn(var1.getBlockId(var2 + Direction.offsetX[var11] + Direction.offsetX[var13], var3,
										var4 + Direction.offsetZ[var11] + Direction.offsetZ[var13]))) {
							var1.setBlockAndMetadataWithNotify(var2 + Direction.offsetX[var11], var3, var4 + Direction.offsetZ[var11],
									this.blockID, 1 << var13);
						} else if ((var9 & 1 << var14) != 0
								&& this.canBePlacedOn(var1.getBlockId(var2 + Direction.offsetX[var11] + Direction.offsetX[var14], var3,
										var4 + Direction.offsetZ[var11] + Direction.offsetZ[var14]))) {
							var1.setBlockAndMetadataWithNotify(var2 + Direction.offsetX[var11], var3, var4 + Direction.offsetZ[var11],
									this.blockID, 1 << var14);
						} else if ((var9 & 1 << var13) != 0
								&& var1.isAirBlock(var2 + Direction.offsetX[var11] + Direction.offsetX[var13], var3,
										var4 + Direction.offsetZ[var11] + Direction.offsetZ[var13])
								&& this.canBePlacedOn(
										var1.getBlockId(var2 + Direction.offsetX[var13], var3, var4 + Direction.offsetZ[var13]))) {
							var1.setBlockAndMetadataWithNotify(var2 + Direction.offsetX[var11] + Direction.offsetX[var13], var3,
									var4 + Direction.offsetZ[var11] + Direction.offsetZ[var13], this.blockID, 1 << (var11 + 2 & 3));
						} else if ((var9 & 1 << var14) != 0
								&& var1.isAirBlock(var2 + Direction.offsetX[var11] + Direction.offsetX[var14], var3,
										var4 + Direction.offsetZ[var11] + Direction.offsetZ[var14])
								&& this.canBePlacedOn(
										var1.getBlockId(var2 + Direction.offsetX[var14], var3, var4 + Direction.offsetZ[var14]))) {
							var1.setBlockAndMetadataWithNotify(var2 + Direction.offsetX[var11] + Direction.offsetX[var14], var3,
									var4 + Direction.offsetZ[var11] + Direction.offsetZ[var14], this.blockID, 1 << (var11 + 2 & 3));
						} else if (this.canBePlacedOn(
								var1.getBlockId(var2 + Direction.offsetX[var11], var3 + 1, var4 + Direction.offsetZ[var11]))) {
							var1.setBlockAndMetadataWithNotify(var2 + Direction.offsetX[var11], var3, var4 + Direction.offsetZ[var11],
									this.blockID, 0);
						}
					}
	...
	public void harvestBlock(World var1, EntityPlayer var2, int var3, int var4, int var5, int var6) {
		if (!var1.isRemote && var2.getCurrentEquippedItem() != null
