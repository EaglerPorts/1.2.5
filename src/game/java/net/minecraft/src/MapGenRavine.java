...
public class MapGenRavine extends MapGenBase {
	...
	protected void generateRavine(long var1, int var3, int var4, byte[] var5, double var6, double var8, double var10,
											...
											if (var52 == Block.stone.blockID || var52 == Block.dirt.blockID || var52 == Block.grass.blockID) {
												if (var49 < 10) {
													...
													if (var48 && var5[var47 - 1] == Block.dirt.blockID) {
														var5[var47 - 1] = this.worldObj.getBiomeGenForCoords(var41 + var3 * 16,
																var44 + var4 * 16).topBlock;
													}
												}
											}
										}
