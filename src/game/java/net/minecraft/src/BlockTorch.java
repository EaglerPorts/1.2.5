...
public class BlockTorch extends Block {
	...
	public boolean canPlaceBlockAt(World var1, int var2, int var3, int var4) {
		return var1.isBlockNormalCubeDefault(var2 - 1, var3, var4, true) ? true
				: (var1.isBlockNormalCubeDefault(var2 + 1, var3, var4, true) ? true
						: (var1.isBlockNormalCubeDefault(var2, var3, var4 - 1, true) ? true
								: (var1.isBlockNormalCubeDefault(var2, var3, var4 + 1, true) ? true
