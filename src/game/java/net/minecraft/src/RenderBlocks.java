...
public class RenderBlocks {
		...
		return var5 == 0 ? this.renderStandardBlock(var1, var2, var3, var4)
				: (var5 == 4 ? this.renderBlockFluids(var1, var2, var3, var4)
						: (var5 == 13 ? this.renderBlockCactus(var1, var2, var3, var4)
								: (var5 == 1 ? this.renderCrossedSquares(var1, var2, var3, var4)
										: (var5 == 19 ? this.renderBlockStem(var1, var2, var3, var4)
												: (var5 == 23 ? this.renderBlockLilyPad(var1, var2, var3, var4)
																				...
																				: (var5 == 5 ? this.renderBlockRedstoneWire(var1, var2, var3, var4)
																						: (var5 == 8 ? this.renderBlockLadder(var1, var2, var3, var4)
																								: (var5 == 7 ? this.renderBlockDoor(var1, var2, var3, var4)
																										: (var5 == 9
																												? this.renderBlockMinecartTrack((BlockRail) var1, var2, var3,
																														var4)
																												: (var5 == 10 ? this.renderBlockStairs(var1, var2, var3, var4)
																														: (var5 == 27
																																? this.renderBlockDragonEgg((BlockDragonEgg) var1, var2,
																																		var3, var4)
																																: (var5 == 11
																																		? this.renderBlockFence((BlockFence) var1, var2,
																																				var3, var4)
																																		: (var5 == 12
																																				? this.renderBlockLever(var1, var2, var3, var4)
																																				: (var5 == 14
																																						? this.renderBlockBed(var1, var2, var3,
																																								var4)
																																						: (var5 == 15
																																								? this.renderBlockRepeater(var1, var2,
																																										var3, var4)
																																								: (var5 == 16
																																										? this.renderPistonBase(var1, var2,
																																												var3, var4, false)
																																										: (var5 == 17
	...
	private boolean renderBlockBed(Block var1, int var2, int var3, int var4) {
		...
		if (var27 != 2 && (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2))) {
			var5.setBrightness(
					var1.minZ > 0.0D ? var25 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3, var4 - 1));
			var5.setColorOpaque_F(var11, var11, var11);
			this.flipTexture = var64 == 2;
			this.renderEastFace(var1, (double) var2, (double) var3, (double) var4,
					var1.getBlockTexture(this.blockAccess, var2, var3, var4, 2));
		}

		if (var27 != 3 && (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3))) {
			var5.setBrightness(
					var1.maxZ < 1.0D ? var25 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3, var4 + 1));
			var5.setColorOpaque_F(var11, var11, var11);
			this.flipTexture = var64 == 3;
			this.renderWestFace(var1, (double) var2, (double) var3, (double) var4,
					var1.getBlockTexture(this.blockAccess, var2, var3, var4, 3));
		}

		if (var27 != 4 && (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4))) {
			var5.setBrightness(
					var1.minZ > 0.0D ? var25 : var1.getMixedBrightnessForBlock(this.blockAccess, var2 - 1, var3, var4));
			var5.setColorOpaque_F(var12, var12, var12);
			this.flipTexture = var64 == 4;
			this.renderNorthFace(var1, (double) var2, (double) var3, (double) var4,
					var1.getBlockTexture(this.blockAccess, var2, var3, var4, 4));
		}

		if (var27 != 5 && (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5))) {
			var5.setBrightness(
					var1.maxZ < 1.0D ? var25 : var1.getMixedBrightnessForBlock(this.blockAccess, var2 + 1, var3, var4));
			var5.setColorOpaque_F(var12, var12, var12);
			this.flipTexture = var64 == 5;
			this.renderSouthFace(var1, (double) var2, (double) var3, (double) var4,
					var1.getBlockTexture(this.blockAccess, var2, var3, var4, 5));
		}
	...
	private boolean renderBlockCauldron(BlockCauldron var1, int var2, int var3, int var4) {
		...
		if (var14 > 0) {
			...
			this.renderTopFace(var1, (double) var2, (double) ((float) var3 - 1.0F + (6.0F + (float) var14 * 3.0F) / 16.0F),
					(double) var4, var15);
		}
	...
	private void renderPistonRodUD(double var1, double var3, double var5, double var7, double var9, double var11,
			float var13, double var14) {
		int var16 = 108;
		if (this.overrideBlockTexture >= 0) {
	...
	private void renderPistonRodSN(double var1, double var3, double var5, double var7, double var9, double var11,
			float var13, double var14) {
		int var16 = 108;
		if (this.overrideBlockTexture >= 0) {
			var16 = this.overrideBlockTexture;
	...
	private void renderPistonRodEW(double var1, double var3, double var5, double var7, double var9, double var11,
			float var13, double var14) {
		int var16 = 108;
		if (this.overrideBlockTexture >= 0) {
			var16 = this.overrideBlockTexture;
	...
	private boolean renderPistonExtension(Block var1, int var2, int var3, int var4, boolean var5) {
		...
		switch (var7) {
			case 0:
				...
				this.renderStandardBlock(var1, var2, var3, var4);
				this.renderPistonRodUD((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
						(double) ((float) var3 + 0.25F), (double) ((float) var3 + 0.25F + var12),
						(double) ((float) var4 + 10.0F / 16.0F), (double) ((float) var4 + 10.0F / 16.0F), var11 * 0.8F, var13);
				this.renderPistonRodUD((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
						(double) ((float) var3 + 0.25F), (double) ((float) var3 + 0.25F + var12),
						(double) ((float) var4 + 6.0F / 16.0F), (double) ((float) var4 + 6.0F / 16.0F), var11 * 0.8F, var13);
				this.renderPistonRodUD((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
						(double) ((float) var3 + 0.25F), (double) ((float) var3 + 0.25F + var12),
						(double) ((float) var4 + 6.0F / 16.0F), (double) ((float) var4 + 10.0F / 16.0F), var11 * 0.6F, var13);
				this.renderPistonRodUD((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
						(double) ((float) var3 + 0.25F), (double) ((float) var3 + 0.25F + var12),
						(double) ((float) var4 + 10.0F / 16.0F), (double) ((float) var4 + 6.0F / 16.0F), var11 * 0.6F, var13);
				break;
			case 1:
			...
			case 2:
				...
				this.renderStandardBlock(var1, var2, var3, var4);
				this.renderPistonRodSN((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
						(double) ((float) var3 + 10.0F / 16.0F), (double) ((float) var3 + 6.0F / 16.0F),
						(double) ((float) var4 + 0.25F), (double) ((float) var4 + 0.25F + var12), var11 * 0.6F, var13);
				this.renderPistonRodSN((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 10.0F / 16.0F),
						(double) ((float) var4 + 0.25F), (double) ((float) var4 + 0.25F + var12), var11 * 0.6F, var13);
				this.renderPistonRodSN((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 6.0F / 16.0F),
						(double) ((float) var4 + 0.25F), (double) ((float) var4 + 0.25F + var12), var11 * 0.5F, var13);
				this.renderPistonRodSN((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
			...
			case 3:
				...
				this.renderPistonRodSN((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
						(double) ((float) var3 + 10.0F / 16.0F), (double) ((float) var3 + 6.0F / 16.0F),
						(double) ((float) var4 - 0.25F + 1.0F - var12), (double) ((float) var4 - 0.25F + 1.0F), var11 * 0.6F,
						var13);
				this.renderPistonRodSN((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 10.0F / 16.0F),
						(double) ((float) var4 - 0.25F + 1.0F - var12), (double) ((float) var4 - 0.25F + 1.0F), var11 * 0.6F,
				...
				this.renderPistonRodSN((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 6.0F / 16.0F),
						(double) ((float) var4 - 0.25F + 1.0F - var12), (double) ((float) var4 - 0.25F + 1.0F), var11 * 0.5F,
						var13);
				this.renderPistonRodSN((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
						(double) ((float) var3 + 10.0F / 16.0F), (double) ((float) var3 + 10.0F / 16.0F),
						(double) ((float) var4 - 0.25F + 1.0F - var12), (double) ((float) var4 - 0.25F + 1.0F), var11, var13);
				break;
			case 4:
				this.uvRotateEast = 1;
				this.uvRotateWest = 2;
				...
				this.renderStandardBlock(var1, var2, var3, var4);
				this.renderPistonRodEW((double) ((float) var2 + 0.25F), (double) ((float) var2 + 0.25F + var12),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 6.0F / 16.0F),
						(double) ((float) var4 + 10.0F / 16.0F), (double) ((float) var4 + 6.0F / 16.0F), var11 * 0.5F, var13);
				this.renderPistonRodEW((double) ((float) var2 + 0.25F), (double) ((float) var2 + 0.25F + var12),
						(double) ((float) var3 + 10.0F / 16.0F), (double) ((float) var3 + 10.0F / 16.0F),
						(double) ((float) var4 + 6.0F / 16.0F), (double) ((float) var4 + 10.0F / 16.0F), var11, var13);
				this.renderPistonRodEW((double) ((float) var2 + 0.25F), (double) ((float) var2 + 0.25F + var12),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 10.0F / 16.0F),
						(double) ((float) var4 + 6.0F / 16.0F), (double) ((float) var4 + 6.0F / 16.0F), var11 * 0.6F, var13);
				this.renderPistonRodEW((double) ((float) var2 + 0.25F), (double) ((float) var2 + 0.25F + var12),
						(double) ((float) var3 + 10.0F / 16.0F), (double) ((float) var3 + 6.0F / 16.0F),
						(double) ((float) var4 + 10.0F / 16.0F), (double) ((float) var4 + 10.0F / 16.0F), var11 * 0.6F, var13);
				break;
			case 5:
				this.uvRotateEast = 2;
				this.uvRotateWest = 1;
				...
				this.renderStandardBlock(var1, var2, var3, var4);
				this.renderPistonRodEW((double) ((float) var2 - 0.25F + 1.0F - var12), (double) ((float) var2 - 0.25F + 1.0F),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 6.0F / 16.0F),
						(double) ((float) var4 + 10.0F / 16.0F), (double) ((float) var4 + 6.0F / 16.0F), var11 * 0.5F, var13);
				this.renderPistonRodEW((double) ((float) var2 - 0.25F + 1.0F - var12), (double) ((float) var2 - 0.25F + 1.0F),
						(double) ((float) var3 + 10.0F / 16.0F), (double) ((float) var3 + 10.0F / 16.0F),
	...
	public boolean renderBlockFire(Block var1, int var2, int var3, int var4) {
		...
		if (!this.blockAccess.isBlockNormalCube(var2, var3 - 1, var4)
				&& !Block.fire.canBlockCatchFire(this.blockAccess, var2, var3 - 1, var4)) {
			float var36 = 0.2F;
			...
			if (Block.fire.canBlockCatchFire(this.blockAccess, var2 - 1, var3, var4)) {
				var5.addVertexWithUV((double) ((float) var2 + var36), (double) ((float) var3 + var17 + var19),
						(double) (var4 + 1), var11, var13);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 0) + var19), (double) (var4 + 1), var11,
						var15);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 0) + var19), (double) (var4 + 0), var9,
						var15);
				var5.addVertexWithUV((double) ((float) var2 + var36), (double) ((float) var3 + var17 + var19),
						(double) (var4 + 0), var9, var13);
				var5.addVertexWithUV((double) ((float) var2 + var36), (double) ((float) var3 + var17 + var19),
						(double) (var4 + 0), var9, var13);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 0) + var19), (double) (var4 + 0), var9,
						var15);
			...
			if (Block.fire.canBlockCatchFire(this.blockAccess, var2 + 1, var3, var4)) {
				var5.addVertexWithUV((double) ((float) (var2 + 1) - var36), (double) ((float) var3 + var17 + var19),
						(double) (var4 + 0), var9, var13);
				var5.addVertexWithUV((double) (var2 + 1 - 0), (double) ((float) (var3 + 0) + var19), (double) (var4 + 0), var9,
						var15);
				var5.addVertexWithUV((double) (var2 + 1 - 0), (double) ((float) (var3 + 0) + var19), (double) (var4 + 1), var11,
						var15);
				var5.addVertexWithUV((double) ((float) (var2 + 1) - var36), (double) ((float) var3 + var17 + var19),
						(double) (var4 + 1), var11, var13);
				var5.addVertexWithUV((double) ((float) (var2 + 1) - var36), (double) ((float) var3 + var17 + var19),
			...
			if (Block.fire.canBlockCatchFire(this.blockAccess, var2, var3, var4 - 1)) {
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) var3 + var17 + var19),
						(double) ((float) var4 + var36), var11, var13);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 0) + var19), (double) (var4 + 0), var11,
						var15);
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) (var3 + 0) + var19), (double) (var4 + 0), var9,
						var15);
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) var3 + var17 + var19),
						(double) ((float) var4 + var36), var9, var13);
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) var3 + var17 + var19),
						(double) ((float) var4 + var36), var9, var13);
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) (var3 + 0) + var19), (double) (var4 + 0), var9,
						var15);
			...
			if (Block.fire.canBlockCatchFire(this.blockAccess, var2, var3, var4 + 1)) {
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) var3 + var17 + var19),
						(double) ((float) (var4 + 1) - var36), var9, var13);
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) (var3 + 0) + var19), (double) (var4 + 1 - 0), var9,
						var15);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 0) + var19), (double) (var4 + 1 - 0), var11,
						var15);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) var3 + var17 + var19),
						(double) ((float) (var4 + 1) - var36), var11, var13);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) var3 + var17 + var19),
						(double) ((float) (var4 + 1) - var36), var11, var13);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 0) + var19), (double) (var4 + 1 - 0), var11,
						var15);
	...
	public boolean renderBlockRedstoneWire(Block var1, int var2, int var3, int var4) {
		...
		boolean var29 = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2 - 1, var3, var4, 1)
				|| !this.blockAccess.isBlockNormalCube(var2 - 1, var3, var4)
						&& BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2 - 1, var3 - 1, var4, -1);
		boolean var30 = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2 + 1, var3, var4, 3)
				|| !this.blockAccess.isBlockNormalCube(var2 + 1, var3, var4)
						&& BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2 + 1, var3 - 1, var4, -1);
		boolean var31 = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2, var3, var4 - 1, 2)
				|| !this.blockAccess.isBlockNormalCube(var2, var3, var4 - 1)
						&& BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2, var3 - 1, var4 - 1, -1);
		boolean var32 = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2, var3, var4 + 1, 0)
				|| !this.blockAccess.isBlockNormalCube(var2, var3, var4 + 1)
						&& BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, var2, var3 - 1, var4 + 1, -1);
		if (!this.blockAccess.isBlockNormalCube(var2, var3 + 1, var4)) {
		...
		if (!this.blockAccess.isBlockNormalCube(var2, var3 + 1, var4)) {
			...
			var21 = (double) (((float) var14 + 15.99F) / 256.0F);
			if (this.blockAccess.isBlockNormalCube(var2 - 1, var3, var4)
					&& this.blockAccess.getBlockId(var2 - 1, var3 + 1, var4) == Block.redstoneWire.blockID) {
				var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
				var5.addVertexWithUV((double) var2 + 1.0D / 64.0D, (double) ((float) (var3 + 1) + 7.0F / 320.0F),
				...
				var5.setColorOpaque_F(var8, var8, var8);
				var5.addVertexWithUV((double) var2 + 1.0D / 64.0D, (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 1), var17, var19 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) var2 + 1.0D / 64.0D, (double) (var3 + 0), (double) (var4 + 1), var15,
						var19 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) var2 + 1.0D / 64.0D, (double) (var3 + 0), (double) (var4 + 0), var15,
						var21 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) var2 + 1.0D / 64.0D, (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 0), var17, var21 + 1.0D / 16.0D);
			}

			if (this.blockAccess.isBlockNormalCube(var2 + 1, var3, var4)
					&& this.blockAccess.getBlockId(var2 + 1, var3 + 1, var4) == Block.redstoneWire.blockID) {
				var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
				var5.addVertexWithUV((double) (var2 + 1) - 1.0D / 64.0D, (double) (var3 + 0), (double) (var4 + 1), var15,
						var21);
				var5.addVertexWithUV((double) (var2 + 1) - 1.0D / 64.0D, (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 1), var17, var21);
				var5.addVertexWithUV((double) (var2 + 1) - 1.0D / 64.0D, (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 0), var17, var19);
				var5.addVertexWithUV((double) (var2 + 1) - 1.0D / 64.0D, (double) (var3 + 0), (double) (var4 + 0), var15,
						var19);
				var5.setColorOpaque_F(var8, var8, var8);
				var5.addVertexWithUV((double) (var2 + 1) - 1.0D / 64.0D, (double) (var3 + 0), (double) (var4 + 1), var15,
						var21 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) (var2 + 1) - 1.0D / 64.0D, (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 1), var17, var21 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) (var2 + 1) - 1.0D / 64.0D, (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 0), var17, var19 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) (var2 + 1) - 1.0D / 64.0D, (double) (var3 + 0), (double) (var4 + 0), var15,
						var19 + 1.0D / 16.0D);
			}

			if (this.blockAccess.isBlockNormalCube(var2, var3, var4 - 1)
					&& this.blockAccess.getBlockId(var2, var3 + 1, var4 - 1) == Block.redstoneWire.blockID) {
				var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
				var5.addVertexWithUV((double) (var2 + 1), (double) (var3 + 0), (double) var4 + 1.0D / 64.0D, var15, var21);
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) var4 + 1.0D / 64.0D, var17, var21);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) var4 + 1.0D / 64.0D, var17, var19);
				var5.addVertexWithUV((double) (var2 + 0), (double) (var3 + 0), (double) var4 + 1.0D / 64.0D, var15, var19);
				var5.setColorOpaque_F(var8, var8, var8);
				var5.addVertexWithUV((double) (var2 + 1), (double) (var3 + 0), (double) var4 + 1.0D / 64.0D, var15,
						var21 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) var4 + 1.0D / 64.0D, var17, var21 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) var4 + 1.0D / 64.0D, var17, var19 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) (var2 + 0), (double) (var3 + 0), (double) var4 + 1.0D / 64.0D, var15,
						var19 + 1.0D / 16.0D);
			}
			...
			if (this.blockAccess.isBlockNormalCube(var2, var3, var4 + 1)
				...
				var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 1) - 1.0D / 64.0D, var17, var19);
				var5.addVertexWithUV((double) (var2 + 1), (double) (var3 + 0), (double) (var4 + 1) - 1.0D / 64.0D, var15,
						var19);
				var5.addVertexWithUV((double) (var2 + 0), (double) (var3 + 0), (double) (var4 + 1) - 1.0D / 64.0D, var15,
						var21);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 1) - 1.0D / 64.0D, var17, var21);
				var5.setColorOpaque_F(var8, var8, var8);
				var5.addVertexWithUV((double) (var2 + 1), (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 1) - 1.0D / 64.0D, var17, var19 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) (var2 + 1), (double) (var3 + 0), (double) (var4 + 1) - 1.0D / 64.0D, var15,
						var19 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) (var2 + 0), (double) (var3 + 0), (double) (var4 + 1) - 1.0D / 64.0D, var15,
						var21 + 1.0D / 16.0D);
				var5.addVertexWithUV((double) (var2 + 0), (double) ((float) (var3 + 1) + 7.0F / 320.0F),
						(double) (var4 + 1) - 1.0D / 64.0D, var17, var21 + 1.0D / 16.0D);
			}
		}
	...
	public boolean renderBlockLadder(Block var1, int var2, int var3, int var4) {
		...
		if (var17 == 5) {
			var5.addVertexWithUV((double) var2 + var20, (double) (var3 + 1) + var18, (double) (var4 + 1) + var18, var9,
					var13);
			var5.addVertexWithUV((double) var2 + var20, (double) (var3 + 0) - var18, (double) (var4 + 1) + var18, var9,
					var15);
			var5.addVertexWithUV((double) var2 + var20, (double) (var3 + 0) - var18, (double) (var4 + 0) - var18, var11,
					var15);
			var5.addVertexWithUV((double) var2 + var20, (double) (var3 + 1) + var18, (double) (var4 + 0) - var18, var11,
					var13);
		}

		if (var17 == 4) {
			var5.addVertexWithUV((double) (var2 + 1) - var20, (double) (var3 + 0) - var18, (double) (var4 + 1) + var18, var11,
					var15);
			var5.addVertexWithUV((double) (var2 + 1) - var20, (double) (var3 + 1) + var18, (double) (var4 + 1) + var18, var11,
					var13);
			var5.addVertexWithUV((double) (var2 + 1) - var20, (double) (var3 + 1) + var18, (double) (var4 + 0) - var18, var9,
					var13);
			var5.addVertexWithUV((double) (var2 + 1) - var20, (double) (var3 + 0) - var18, (double) (var4 + 0) - var18, var9,
					var15);
		}

		if (var17 == 3) {
			var5.addVertexWithUV((double) (var2 + 1) + var18, (double) (var3 + 0) - var18, (double) var4 + var20, var11,
					var15);
			var5.addVertexWithUV((double) (var2 + 1) + var18, (double) (var3 + 1) + var18, (double) var4 + var20, var11,
					var13);
			var5.addVertexWithUV((double) (var2 + 0) - var18, (double) (var3 + 1) + var18, (double) var4 + var20, var9,
					var13);
			var5.addVertexWithUV((double) (var2 + 0) - var18, (double) (var3 + 0) - var18, (double) var4 + var20, var9,
					var15);
		}

		if (var17 == 2) {
			var5.addVertexWithUV((double) (var2 + 1) + var18, (double) (var3 + 1) + var18, (double) (var4 + 1) - var20, var9,
					var13);
			var5.addVertexWithUV((double) (var2 + 1) + var18, (double) (var3 + 0) - var18, (double) (var4 + 1) - var20, var9,
					var15);
			var5.addVertexWithUV((double) (var2 + 0) - var18, (double) (var3 + 0) - var18, (double) (var4 + 1) - var20, var11,
					var15);
			var5.addVertexWithUV((double) (var2 + 0) - var18, (double) (var3 + 1) + var18, (double) (var4 + 1) - var20, var11,
					var13);
		}
	...
	public boolean renderBlockStem(Block var1, int var2, int var3, int var4) {
		...
		if (var15 < 0) {
			this.renderBlockStemSmall(var5, this.blockAccess.getBlockMetadata(var2, var3, var4), var5.maxY, (double) var2,
					(double) var3, (double) var4);
		} else {
			this.renderBlockStemSmall(var5, this.blockAccess.getBlockMetadata(var2, var3, var4), 0.5D, (double) var2,
					(double) var3, (double) var4);
			this.renderBlockStemBig(var5, this.blockAccess.getBlockMetadata(var2, var3, var4), var15, var5.maxY,
	...
	public boolean renderBlockCrops(Block var1, int var2, int var3, int var4) {
		...
		var5.setBrightness(var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3, var4));
		var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		this.renderBlockCropsImpl(var1, this.blockAccess.getBlockMetadata(var2, var3, var4), (double) var2,
				(double) ((float) var3 - 1.0F / 16.0F), (double) var4);
		return true;
	}
	...
	public void renderTorchAtAngle(Block var1, double var2, double var4, double var6, double var8, double var10) {
		...
		double var38 = 0.625D;
		var12.addVertexWithUV(var2 + var8 * (1.0D - var38) - var36, var4 + var38, var6 + var10 * (1.0D - var38) - var36,
				var20, var22);
		var12.addVertexWithUV(var2 + var8 * (1.0D - var38) - var36, var4 + var38, var6 + var10 * (1.0D - var38) + var36,
				var20, var26);
		var12.addVertexWithUV(var2 + var8 * (1.0D - var38) + var36, var4 + var38, var6 + var10 * (1.0D - var38) + var36,
	...
	public boolean renderBlockLilyPad(Block var1, int var2, int var3, int var4) {
		...
		var5.addVertexWithUV((double) (var21 + var23 - var24), (double) ((float) var3 + var9),
				(double) (var22 + var23 + var24), var10, var14);
		var5.addVertexWithUV((double) (var21 + var23 + var24), (double) ((float) var3 + var9),
				(double) (var22 - var23 + var24), var12, var14);
		var5.addVertexWithUV((double) (var21 - var23 + var24), (double) ((float) var3 + var9),
				(double) (var22 - var23 - var24), var12, var16);
		var5.addVertexWithUV((double) (var21 - var23 - var24), (double) ((float) var3 + var9),
				(double) (var22 + var23 - var24), var10, var16);
	...
	public boolean renderBlockFluids(Block var1, int var2, int var3, int var4) {
		...
		boolean[] var12 = new boolean[] { var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2),
				var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3),
				var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4),
				var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5) };
		if (!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
			...
			if (this.renderAllFaces || var10) {
				...
				var5.addVertexWithUV((double) (var2 + 0), (double) var3 + var24, (double) (var4 + 0), var38 - var44 - var42,
						var40 - var44 + var42);
				var5.addVertexWithUV((double) (var2 + 0), (double) var3 + var26, (double) (var4 + 1), var38 - var44 + var42,
						var40 + var44 + var42);
				var5.addVertexWithUV((double) (var2 + 1), (double) var3 + var28, (double) (var4 + 1), var38 + var44 + var42,
						var40 + var44 - var42);
				var5.addVertexWithUV((double) (var2 + 1), (double) var3 + var30, (double) (var4 + 0), var38 + var44 - var42,
						var40 - var44 - var42);
			}
			...
			if (this.renderAllFaces || var11) {
				...
				this.renderBottomFace(var1, (double) var2, (double) var3 + var32, (double) var4,
						var1.getBlockTextureFromSide(0));
				var13 = true;
			}
	...
	public boolean renderStandardBlock(Block var1, int var2, int var3, int var4) {
		...
		return Minecraft.isAmbientOcclusionEnabled() && Block.lightValue[var1.blockID] == 0
	...
	public boolean renderStandardBlockWithAmbientOcclusion(Block var1, int var2, int var3, int var4, float var5,
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 - 1, var4, 0)) {
			if (this.aoType > 0) {
				...
				if (!this.aoGrassXYZCNN && !this.aoGrassXYZNNC) {
					...
					this.aoLightValueScratchXYZNNN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 - 1, var3,
							var4 - 1);
				...
				if (!this.aoGrassXYZCNP && !this.aoGrassXYZNNC) {
					...
					this.aoLightValueScratchXYZNNP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 - 1, var3,
							var4 + 1);
				...
				if (!this.aoGrassXYZCNN && !this.aoGrassXYZPNC) {
					...
					this.aoLightValueScratchXYZPNN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 + 1, var3,
							var4 - 1);
				...
				if (!this.aoGrassXYZCNP && !this.aoGrassXYZPNC) {
					...
					this.aoLightValueScratchXYZPNP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 + 1, var3,
							var4 + 1);
				...
				var9 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXYNN + this.aoLightValueScratchYZNP
						+ this.aoLightValueYNeg) / 4.0F;
				var12 = (this.aoLightValueScratchYZNP + this.aoLightValueYNeg + this.aoLightValueScratchXYZPNP
						+ this.aoLightValueScratchXYPN) / 4.0F;
				var11 = (this.aoLightValueYNeg + this.aoLightValueScratchYZNN + this.aoLightValueScratchXYPN
						+ this.aoLightValueScratchXYZPNN) / 4.0F;
				var10 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNN + this.aoLightValueYNeg
			...
			this.colorRedTopLeft = this.colorRedBottomLeft = this.colorRedBottomRight = this.colorRedTopRight = (var13 ? var5
					: 1.0F) * 0.5F;
			this.colorGreenTopLeft = this.colorGreenBottomLeft = this.colorGreenBottomRight = this.colorGreenTopRight = (var13
					? var6
					: 1.0F) * 0.5F;
			this.colorBlueTopLeft = this.colorBlueBottomLeft = this.colorBlueBottomRight = this.colorBlueTopRight = (var13
					? var7
					: 1.0F) * 0.5F;
			...
			this.renderBottomFace(var1, (double) var2, (double) var3, (double) var4,
					var1.getBlockTexture(this.blockAccess, var2, var3, var4, 0));
			var8 = true;
		}
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 + 1, var4, 1)) {
			if (this.aoType > 0) {
				...
				if (!this.aoGrassXYZCPN && !this.aoGrassXYZNPC) {
					...
					this.aoLightValueScratchXYZNPN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 - 1, var3,
							var4 - 1);
				...
				if (!this.aoGrassXYZCPN && !this.aoGrassXYZPPC) {
					...
					this.aoLightValueScratchXYZPPN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 + 1, var3,
							var4 - 1);
				...
				if (!this.aoGrassXYZCPP && !this.aoGrassXYZNPC) {
					...
					this.aoLightValueScratchXYZNPP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 - 1, var3,
							var4 + 1);
				...
				if (!this.aoGrassXYZCPP && !this.aoGrassXYZPPC) {
					...
					this.aoLightValueScratchXYZPPP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 + 1, var3,
							var4 + 1);
				...
				var12 = (this.aoLightValueScratchXYZNPP + this.aoLightValueScratchXYNP + this.aoLightValueScratchYZPP
						+ this.aoLightValueYPos) / 4.0F;
				var9 = (this.aoLightValueScratchYZPP + this.aoLightValueYPos + this.aoLightValueScratchXYZPPP
						+ this.aoLightValueScratchXYPP) / 4.0F;
				var10 = (this.aoLightValueYPos + this.aoLightValueScratchYZPN + this.aoLightValueScratchXYPP
						+ this.aoLightValueScratchXYZPPN) / 4.0F;
				var11 = (this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPN + this.aoLightValueYPos
			...
			this.colorRedTopLeft = this.colorRedBottomLeft = this.colorRedBottomRight = this.colorRedTopRight = var14 ? var5
					: 1.0F;
			this.colorGreenTopLeft = this.colorGreenBottomLeft = this.colorGreenBottomRight = this.colorGreenTopRight = var14
					? var6
					: 1.0F;
			this.colorBlueTopLeft = this.colorBlueBottomLeft = this.colorBlueBottomRight = this.colorBlueTopRight = var14
					? var7
					: 1.0F;
			this.colorRedTopLeft *= var9;
			this.colorGreenTopLeft *= var9;
			...
			this.colorGreenTopRight *= var12;
			this.colorBlueTopRight *= var12;
			this.renderTopFace(var1, (double) var2, (double) var3, (double) var4,
					var1.getBlockTexture(this.blockAccess, var2, var3, var4, 1));
			var8 = true;
		}
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2)) {
			if (this.aoType > 0) {
				...
				if (!this.aoGrassXYZNCN && !this.aoGrassXYZCNN) {
					...
					this.aoLightValueScratchXYZNNN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 - 1, var3 - 1,
							var4);
				...
				if (!this.aoGrassXYZNCN && !this.aoGrassXYZCPN) {
					...
					this.aoLightValueScratchXYZNPN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 - 1, var3 + 1,
							var4);
				...
				if (!this.aoGrassXYZPCN && !this.aoGrassXYZCNN) {
					...
					this.aoLightValueScratchXYZPNN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 + 1, var3 - 1,
							var4);
				...
				if (!this.aoGrassXYZPCN && !this.aoGrassXYZCPN) {
					...
					this.aoLightValueScratchXYZPPN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 + 1, var3 + 1,
							var4);
				...
				var9 = (this.aoLightValueScratchXZNN + this.aoLightValueScratchXYZNPN + this.aoLightValueZNeg
						+ this.aoLightValueScratchYZPN) / 4.0F;
				var10 = (this.aoLightValueZNeg + this.aoLightValueScratchYZPN + this.aoLightValueScratchXZPN
						+ this.aoLightValueScratchXYZPPN) / 4.0F;
				var11 = (this.aoLightValueScratchYZNN + this.aoLightValueZNeg + this.aoLightValueScratchXYZPNN
			...
			this.colorRedTopLeft = this.colorRedBottomLeft = this.colorRedBottomRight = this.colorRedTopRight = (var15 ? var5
					: 1.0F) * 0.8F;
			this.colorGreenTopLeft = this.colorGreenBottomLeft = this.colorGreenBottomRight = this.colorGreenTopRight = (var15
					? var6
					: 1.0F) * 0.8F;
			this.colorBlueTopLeft = this.colorBlueBottomLeft = this.colorBlueBottomRight = this.colorBlueTopRight = (var15
					? var7
					: 1.0F) * 0.8F;
			this.colorRedTopLeft *= var9;
			this.colorGreenTopLeft *= var9;
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3)) {
			if (this.aoType > 0) {
				...
				if (!this.aoGrassXYZNCP && !this.aoGrassXYZCNP) {
					...
					this.aoLightValueScratchXYZNNP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 - 1, var3 - 1,
							var4);
				...
				if (!this.aoGrassXYZNCP && !this.aoGrassXYZCPP) {
					...
					this.aoLightValueScratchXYZNPP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 - 1, var3 + 1,
							var4);
				...
				if (!this.aoGrassXYZPCP && !this.aoGrassXYZCNP) {
					...
					this.aoLightValueScratchXYZPNP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 + 1, var3 - 1,
							var4);
				...
				if (!this.aoGrassXYZPCP && !this.aoGrassXYZCPP) {
					...
					this.aoLightValueScratchXYZPPP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2 + 1, var3 + 1,
							var4);
				...
				var9 = (this.aoLightValueScratchXZNP + this.aoLightValueScratchXYZNPP + this.aoLightValueZPos
						+ this.aoLightValueScratchYZPP) / 4.0F;
				var12 = (this.aoLightValueZPos + this.aoLightValueScratchYZPP + this.aoLightValueScratchXZPP
						+ this.aoLightValueScratchXYZPPP) / 4.0F;
				var11 = (this.aoLightValueScratchYZNP + this.aoLightValueZPos + this.aoLightValueScratchXYZPNP
			...
			this.colorRedTopLeft = this.colorRedBottomLeft = this.colorRedBottomRight = this.colorRedTopRight = (var16 ? var5
					: 1.0F) * 0.8F;
			this.colorGreenTopLeft = this.colorGreenBottomLeft = this.colorGreenBottomRight = this.colorGreenTopRight = (var16
					? var6
					: 1.0F) * 0.8F;
			this.colorBlueTopLeft = this.colorBlueBottomLeft = this.colorBlueBottomRight = this.colorBlueTopRight = (var16
					? var7
					: 1.0F) * 0.8F;
			this.colorRedTopLeft *= var9;
			this.colorGreenTopLeft *= var9;
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4)) {
			if (this.aoType > 0) {
				...
				if (!this.aoGrassXYZNCN && !this.aoGrassXYZNNC) {
					...
					this.aoLightValueScratchXYZNNN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2, var3 - 1,
							var4 - 1);
				...
				if (!this.aoGrassXYZNCP && !this.aoGrassXYZNNC) {
					...
					this.aoLightValueScratchXYZNNP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2, var3 - 1,
							var4 + 1);
				...
				if (!this.aoGrassXYZNCN && !this.aoGrassXYZNPC) {
					...
					this.aoLightValueScratchXYZNPN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2, var3 + 1,
							var4 - 1);
				...
				if (!this.aoGrassXYZNCP && !this.aoGrassXYZNPC) {
					...
					this.aoLightValueScratchXYZNPP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2, var3 + 1,
							var4 + 1);
				...
				var12 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNP + this.aoLightValueXNeg
						+ this.aoLightValueScratchXZNP) / 4.0F;
				var9 = (this.aoLightValueXNeg + this.aoLightValueScratchXZNP + this.aoLightValueScratchXYNP
						+ this.aoLightValueScratchXYZNPP) / 4.0F;
				var10 = (this.aoLightValueScratchXZNN + this.aoLightValueXNeg + this.aoLightValueScratchXYZNPN
			...
			this.colorRedTopLeft = this.colorRedBottomLeft = this.colorRedBottomRight = this.colorRedTopRight = (var17 ? var5
					: 1.0F) * 0.6F;
			this.colorGreenTopLeft = this.colorGreenBottomLeft = this.colorGreenBottomRight = this.colorGreenTopRight = (var17
					? var6
					: 1.0F) * 0.6F;
			this.colorBlueTopLeft = this.colorBlueBottomLeft = this.colorBlueBottomRight = this.colorBlueTopRight = (var17
					? var7
					: 1.0F) * 0.6F;
			this.colorRedTopLeft *= var9;
			this.colorGreenTopLeft *= var9;
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5)) {
			if (this.aoType > 0) {
				...
				if (!this.aoGrassXYZPNC && !this.aoGrassXYZPCN) {
					...
					this.aoLightValueScratchXYZPNN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2, var3 - 1,
							var4 - 1);
				...
				if (!this.aoGrassXYZPNC && !this.aoGrassXYZPCP) {
					...
					this.aoLightValueScratchXYZPNP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2, var3 - 1,
							var4 + 1);
				...
				if (!this.aoGrassXYZPPC && !this.aoGrassXYZPCN) {
					...
					this.aoLightValueScratchXYZPPN = var1.getAmbientOcclusionLightValue(this.blockAccess, var2, var3 + 1,
							var4 - 1);
				...
				if (!this.aoGrassXYZPPC && !this.aoGrassXYZPCP) {
					...
					this.aoLightValueScratchXYZPPP = var1.getAmbientOcclusionLightValue(this.blockAccess, var2, var3 + 1,
							var4 + 1);
			...
			this.colorRedTopLeft = this.colorRedBottomLeft = this.colorRedBottomRight = this.colorRedTopRight = (var18 ? var5
					: 1.0F) * 0.6F;
			this.colorGreenTopLeft = this.colorGreenBottomLeft = this.colorGreenBottomRight = this.colorGreenTopRight = (var18
					? var6
					: 1.0F) * 0.6F;
			this.colorBlueTopLeft = this.colorBlueBottomLeft = this.colorBlueBottomRight = this.colorBlueTopRight = (var18
					? var7
					: 1.0F) * 0.6F;
			this.colorRedTopLeft *= var9;
			this.colorGreenTopLeft *= var9;
	...
	public boolean renderStandardBlockWithColorMultiplier(Block var1, int var2, int var3, int var4, float var5,
			float var6, float var7) {
		this.enableAO = false;
		Tessellator var8 = Tessellator.instance;
		boolean var9 = false;
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 - 1, var4, 0)) {
			var8.setBrightness(
					var1.minY > 0.0D ? var26 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3 - 1, var4));
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 + 1, var4, 1)) {
			var8.setBrightness(
					var1.maxY < 1.0D ? var26 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3 + 1, var4));
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2)) {
			var8.setBrightness(
					var1.minZ > 0.0D ? var26 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3, var4 - 1));
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3)) {
			var8.setBrightness(
					var1.maxZ < 1.0D ? var26 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3, var4 + 1));
			var8.setColorOpaque_F(var18, var21, var24);
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4)) {
			var8.setBrightness(
					var1.minX > 0.0D ? var26 : var1.getMixedBrightnessForBlock(this.blockAccess, var2 - 1, var3, var4));
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5)) {
			var8.setBrightness(
					var1.maxX < 1.0D ? var26 : var1.getMixedBrightnessForBlock(this.blockAccess, var2 + 1, var3, var4));
			var8.setColorOpaque_F(var19, var22, var25);
	...
	public boolean renderBlockCactusImpl(Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 - 1, var4, 0)) {
			var8.setBrightness(
					var1.minY > 0.0D ? var28 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3 - 1, var4));
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 + 1, var4, 1)) {
			var8.setBrightness(
					var1.maxY < 1.0D ? var28 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3 + 1, var4));
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2)) {
			var8.setBrightness(
					var1.minZ > 0.0D ? var28 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3, var4 - 1));
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3)) {
			var8.setBrightness(
					var1.maxZ < 1.0D ? var28 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3, var4 + 1));
			var8.setColorOpaque_F(var16, var20, var24);
			var8.setTranslationF(0.0F, 0.0F, -var26);
			this.renderWestFace(var1, (double) var2, (double) var3, (double) var4,
					var1.getBlockTexture(this.blockAccess, var2, var3, var4, 3));
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4)) {
			var8.setBrightness(
					var1.minX > 0.0D ? var28 : var1.getMixedBrightnessForBlock(this.blockAccess, var2 - 1, var3, var4));
		...
		if (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5)) {
			var8.setBrightness(
					var1.maxX < 1.0D ? var28 : var1.getMixedBrightnessForBlock(this.blockAccess, var2 + 1, var3, var4));
			var8.setColorOpaque_F(var17, var21, var25);
			var8.setTranslationF(-var26, 0.0F, 0.0F);
			this.renderSouthFace(var1, (double) var2, (double) var3, (double) var4,
					var1.getBlockTexture(this.blockAccess, var2, var3, var4, 5));
	...
	public boolean renderBlockFence(BlockFence var1, int var2, int var3, int var4) {
		...
		boolean var8 = false;
		boolean var9 = false;
		if (var1.canConnectFenceTo(this.blockAccess, var2 - 1, var3, var4)
				|| var1.canConnectFenceTo(this.blockAccess, var2 + 1, var3, var4)) {
			var8 = true;
		}

		if (var1.canConnectFenceTo(this.blockAccess, var2, var3, var4 - 1)
				|| var1.canConnectFenceTo(this.blockAccess, var2, var3, var4 + 1)) {
			var9 = true;
		}
	...
	public boolean renderBlockDoor(Block var1, int var2, int var3, int var4) {
		...
		var5.setBrightness(
				var1.minY > 0.0D ? var12 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3 - 1, var4));
		var5.setColorOpaque_F(var8, var8, var8);
		this.renderBottomFace(var1, (double) var2, (double) var3, (double) var4,
				var1.getBlockTexture(this.blockAccess, var2, var3, var4, 0));
		var7 = true;
		var5.setBrightness(
				var1.maxY < 1.0D ? var12 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3 + 1, var4));
		var5.setColorOpaque_F(var9, var9, var9);
		this.renderTopFace(var1, (double) var2, (double) var3, (double) var4,
				var1.getBlockTexture(this.blockAccess, var2, var3, var4, 1));
		var7 = true;
		var5.setBrightness(
				var1.minZ > 0.0D ? var12 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3, var4 - 1));
		var5.setColorOpaque_F(var10, var10, var10);
		...
		this.flipTexture = false;
		var5.setBrightness(
				var1.maxZ < 1.0D ? var12 : var1.getMixedBrightnessForBlock(this.blockAccess, var2, var3, var4 + 1));
		var5.setColorOpaque_F(var10, var10, var10);
		...
		this.flipTexture = false;
		var5.setBrightness(
				var1.minX > 0.0D ? var12 : var1.getMixedBrightnessForBlock(this.blockAccess, var2 - 1, var3, var4));
		var5.setColorOpaque_F(var11, var11, var11);
		...
		this.flipTexture = false;
		var5.setBrightness(
				var1.maxX < 1.0D ? var12 : var1.getMixedBrightnessForBlock(this.blockAccess, var2 + 1, var3, var4));
		var5.setColorOpaque_F(var11, var11, var11);
		...
		if (var6 != 0 && var6 != 16) {
			if (var6 == 1) {
				...
				for (var14 = 0; var14 < 4; ++var14) {
					...
					var8 = 1.0F / 16.0F;
					if (var14 == 2) {
						var1.setBlockBounds(0.5F - var8, 1.0F - var8 * 3.0F, -var8 * 2.0F, 0.5F + var8, 1.0F - var8,
								1.0F + var8 * 2.0F);
					}

					if (var14 == 3) {
						var1.setBlockBounds(0.5F - var8, 0.5F - var8 * 3.0F, -var8 * 2.0F, 0.5F + var8, 0.5F - var8,
								1.0F + var8 * 2.0F);
					}
	...
	public static boolean renderItemIn3d(int var0) {
		return var0 == 0 ? true
				: (var0 == 13 ? true
						: (var0 == 10 ? true
								: (var0 == 11 ? true : (var0 == 27 ? true : (var0 == 22 ? true : (var0 == 21 ? true : var0 == 16))))));
	}
}
