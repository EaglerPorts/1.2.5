	...
	private void spawnHeartParticles(EntityLiving var1) {
		...
		for (int var3 = 0; var3 < 5; ++var3) {
			...
			this.worldObj.spawnParticle("heart",
					var1.posX + (double) (var2.nextFloat() * var1.width * 2.0F) - (double) var1.width,
					var1.posY + 1.0D + (double) (var2.nextFloat() * var1.height),
					var1.posZ + (double) (var2.nextFloat() * var1.width * 2.0F) - (double) var1.width, var4, var6, var8);
		}
