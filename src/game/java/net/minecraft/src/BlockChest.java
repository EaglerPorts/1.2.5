...
public class BlockChest extends BlockContainer {
		...
		if (var5 != null) {
			for (int var6 = 0; var6 < var5.getSizeInventory(); ++var6) {
				...
				if (var7 != null) {
					...
					EntityItem var12;
					for (float var10 = this.random.nextFloat() * 0.8F + 0.1F; var7.stackSize > 0; var1
						...
						var12 = new EntityItem(var1, (double) ((float) var2 + var8), (double) ((float) var3 + var9),
	...
	public boolean blockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5) {
		...
		if (var6 == null) {
			...
			return true;
				...
				|| !var1.isBlockNormalCube(var2 - 1, var3 + 1, var4) && !func_50075_j(var1, var2 - 1, var3, var4)) {
			if (var1.getBlockId(var2 + 1, var3, var4) != this.blockID
					|| !var1.isBlockNormalCube(var2 + 1, var3 + 1, var4) && !func_50075_j(var1, var2 + 1, var3, var4)) {
				if (var1.getBlockId(var2, var3, var4 - 1) != this.blockID
						|| !var1.isBlockNormalCube(var2, var3 + 1, var4 - 1) && !func_50075_j(var1, var2, var3, var4 - 1)) {
					if (var1.getBlockId(var2, var3, var4 + 1) != this.blockID
							|| !var1.isBlockNormalCube(var2, var3 + 1, var4 + 1) && !func_50075_j(var1, var2, var3, var4 + 1)) {
						if (var1.getBlockId(var2 - 1, var3, var4) == this.blockID) {
							var6 = new InventoryLargeChest("Large chest",
									(TileEntityChest) var1.getBlockTileEntity(var2 - 1, var3, var4), (IInventory) var6);
						}
						...
						if (var1.getBlockId(var2, var3, var4 - 1) == this.blockID) {
							var6 = new InventoryLargeChest("Large chest",
									(TileEntityChest) var1.getBlockTileEntity(var2, var3, var4 - 1), (IInventory) var6);
						}
	...
	private static boolean func_50075_j(World var0, int var1, int var2, int var3) {
		Iterator var4 = var0
				.getEntitiesWithinAABB(EntityOcelot.class, AxisAlignedBB.getBoundingBoxFromPool((double) var1,
						(double) (var2 + 1), (double) var3, (double) (var1 + 1), (double) (var2 + 2), (double) (var3 + 1)))
				.iterator();
