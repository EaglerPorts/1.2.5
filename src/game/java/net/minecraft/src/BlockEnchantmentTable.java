...
public class BlockEnchantmentTable extends BlockContainer {
				...
				if (var5.nextInt(16) == 0) {
					for (int var8 = var3; var8 <= var3 + 1; ++var8) {
						if (var1.getBlockId(var6, var8, var7) == Block.bookShelf.blockID) {
							...
							var1.spawnParticle("enchantmenttable", (double) var2 + 0.5D, (double) var3 + 2.0D, (double) var4 + 0.5D,
	...
	public int getBlockTextureFromSide(int var1) {
		return var1 == 0 ? this.blockIndexInTexture + 17
				: (var1 == 1 ? this.blockIndexInTexture : this.blockIndexInTexture + 16);
	}
