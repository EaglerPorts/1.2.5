...
public class EffectRenderer {
				...
				for (int var9 = 0; var9 < var7; ++var9) {
					for (int var10 = 0; var10 < var7; ++var10) {
						...
						this.addEffect((new EntityDiggingFX(this.worldObj, var11, var13, var15, var11 - (double) var1 - 0.5D,
								var13 - (double) var2 - 0.5D, var15 - (double) var3 - 0.5D, var6, var17, var5))
								.func_4041_a(var1, var2, var3));
					}
				}
			}
	...
	public void addBlockHitEffects(int var1, int var2, int var3, int var4) {
		...
		if (var5 != 0) {
			...
			this.addEffect((new EntityDiggingFX(this.worldObj, var8, var10, var12, 0.0D, 0.0D, 0.0D, var6, var4,
					this.worldObj.getBlockMetadata(var1, var2, var3))).func_4041_a(var1, var2, var3).multiplyVelocity(0.2F)
					.func_405_d(0.6F));
		}
	}
