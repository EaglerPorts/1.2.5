...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
			...
			if (this.mc.playerController.shouldDrawHUD()) {
				...
				for (var25 = 0; var25 < 10; ++var25) {
					...
					if (this.mc.thePlayer.getFoodStats().getSaturationLevel() <= 0.0F
							&& this.updateCounter % (var16 * 3 + 1) == 0) {
		...
		if (this.mc.gameSettings.showDebugInfo) {
			...
			long var35 = EagRuntime.maxMemory();
			long var36 = EagRuntime.totalMemory();
			long var41 = EagRuntime.freeMemory();
			long var42 = var36 - var41;
			String var44 = "Used memory: " + var42 * 100L / var35 + "% (" + var42 / 1024L / 1024L + "MB) of "
					+ var35 / 1024L / 1024L + "MB";
			...
			if (this.mc.theWorld != null && this.mc.theWorld.blockExists(var45, var22, var23)) {
				...
				this.drawString(var8,
						"lc: " + (var48.getTopFilledSegment() + 15) + " b: "
								+ var48.func_48490_a(var45 & 15, var23 & 15, this.mc.theWorld.getWorldChunkManager()).biomeName
								+ " bl: " + var48.getSavedLightValue(EnumSkyBlock.Block, var45 & 15, var22, var23 & 15) + " sl: "
								+ var48.getSavedLightValue(EnumSkyBlock.Sky, var45 & 15, var22, var23 & 15) + " rl: "
								+ var48.getBlockLightValue(var45 & 15, var22, var23 & 15, 0),
						2, 96, 14737632);
			}
			...
			if (this.mc.gameSettings.showFramerate) var8.drawStringWithShadow(this.mc.fps + " FPS", 2, 2, 16777215);
	...
	public void addChatMessage(String var1) {
		...
		boolean var3 = true;
		Iterator var4 = this.mc.fontRenderer.listFormattedStringToWidth(var1, 320).iterator();
		...
		if (!this.isChatOpen()) {
			...
			if (var1 >= 0 && var2 >= 0) {
				...
				if (var1 <= 320 && var2 < this.mc.fontRenderer.FONT_HEIGHT * var4 + var4) {
					...
					return new ChatClickData(this.mc.fontRenderer, (ChatLine) this.chatMessageList.get(var5), var1,
							var2 - (var5 - this.field_50017_n) * this.mc.fontRenderer.FONT_HEIGHT + var5);
				} else {
					return null;
				}
			} else {
