...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void generateTerrain(int var1, int var2, byte[] var3) {
		...
		this.biomesForGeneration = this.worldObj.getWorldChunkManager().getBiomesForGeneration(this.biomesForGeneration,
				var1 * 4 - 2, var2 * 4 - 2, var7 + 5, var9 + 5);
	...
	public void replaceBlocksForBiome(int var1, int var2, byte[] var3, BiomeGenBase[] var4) {
		...
		this.stoneNoise = this.noiseGen4.generateNoiseOctaves(this.stoneNoise, var1 * 16, var2 * 16, 0, 16, 16, 1,
	...
	private double[] initializeNoiseField(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		this.noise3 = this.noiseGen3.generateNoiseOctaves(this.noise3, var2, var3, var4, var5, var6, var7, var43 / 80.0D,
				var44 / 160.0D, var43 / 80.0D);
		this.noise1 = this.noiseGen1.generateNoiseOctaves(this.noise1, var2, var3, var4, var5, var6, var7, var43, var44,
				var43);
		this.noise2 = this.noiseGen2.generateNoiseOctaves(this.noise2, var2, var3, var4, var5, var6, var7, var43, var44,
				var43);
		boolean var42 = false;
		int var12 = 0;
		int var13 = 0;
	...
	public ChunkPosition findClosestStructure(World var1, String var2, int var3, int var4, int var5) {
		return "Stronghold".equals(var2) && this.strongholdGenerator != null
				? this.strongholdGenerator.getNearestInstance(var1, var3, var4, var5)
				: null;
	}
}
