...
public class BlockMycelium extends Block {
		...
		if (!var1.isRemote) {
			if (var1.getBlockLightValue(var2, var3 + 1, var4) < 4
				...
				for (int var6 = 0; var6 < 4; ++var6) {
					...
					if (var1.getBlockId(var7, var8, var9) == Block.dirt.blockID
							&& var1.getBlockLightValue(var7, var8 + 1, var9) >= 4 && Block.lightOpacity[var10] <= 2) {
	...
	public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5) {
		...
		if (var5.nextInt(10) == 0) {
			var1.spawnParticle("townaura", (double) ((float) var2 + var5.nextFloat()), (double) ((float) var3 + 1.1F),
					(double) ((float) var4 + var5.nextFloat()), 0.0D, 0.0D, 0.0D);
		}
