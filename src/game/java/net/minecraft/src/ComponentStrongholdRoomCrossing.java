...
public class ComponentStrongholdRoomCrossing extends ComponentStronghold {
	...
	public static ComponentStrongholdRoomCrossing findValidPlacement(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -4, -1, 0, 11, 7,
				11, var5);
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		if (this.isLiquidInStructureBoundingBox(var1, var3)) {
			...
			this.fillWithRandomizedBlocks(var1, var3, 0, 0, 0, 10, 6, 10, true, var2,
			...
			switch (this.roomType) {
				...
				case 2:
					...
					this.placeBlockAtCurrentPosition(var1, Block.ladder.blockID,
							this.getMetadataWithOffset(Block.ladder.blockID, 4), 9, 1, 3, var3);
					this.placeBlockAtCurrentPosition(var1, Block.ladder.blockID,
							this.getMetadataWithOffset(Block.ladder.blockID, 4), 9, 2, 3, var3);
					this.placeBlockAtCurrentPosition(var1, Block.ladder.blockID,
							this.getMetadataWithOffset(Block.ladder.blockID, 4), 9, 3, 3, var3);
