...
public class GuiAchievements extends GuiScreen {
	...
	public GuiAchievements(StatFileWriter var1) {
		...
		short var2 = 141;
		short var3 = 141;
		this.field_27116_m = this.guiMapX = this.field_27112_q = (double) (AchievementList.openInventory.displayColumn * 24
				- var2 / 2 - 12);
		this.field_27115_n = this.guiMapY = this.field_27111_r = (double) (AchievementList.openInventory.displayRow * 24
				- var3 / 2);
	}
	...
	public void drawScreen(int var1, int var2, float var3) {
		if (Mouse.isButtonDown(0)) {
			...
			int var6 = var4 + 8;
			int var7 = var5 + 17;
			if ((this.isMouseButtonDown == 0 || this.isMouseButtonDown == 1) && var1 >= var6 && var1 < var6 + 224
					&& var2 >= var7 && var2 < var7 + 155) {
	...
	protected void genAchievementBackground(int var1, int var2, float var3) {
		...
		for (var24 = 0; var24 < AchievementList.achievementList.size(); ++var24) {
			...
			if (var26 >= -24 && var27 >= -24 && var26 <= 224 && var27 <= 155) {
				...
				if (var1 >= var10 && var2 >= var11 && var1 < var10 + 224 && var2 < var11 + 155 && var1 >= var39
						&& var1 <= var39 + 22 && var2 >= var40 && var2 <= var40 + 22) {
					var32 = var35;
				}
			}
		}
		...
		if (var32 != null) {
			...
			if (this.statFileWriter.canUnlockAchievement(var32)) {
				...
				this.drawGradientRect(var26 - 3, var27 - 3, var26 + var39 + 3, var27 + var40 + 3 + 12, -1073741824,
						-1073741824);
				this.fontRenderer.drawSplitString(var37, var26, var27 + 12, var39, -6250336);
				if (this.statFileWriter.hasAchievementUnlocked(var32)) {
					this.fontRenderer.drawStringWithShadow(StatCollector.translateToLocal("achievement.taken"), var26,
							var27 + var40 + 4, -7302913);
				}
			} else {
				var39 = Math.max(this.fontRenderer.getStringWidth(var36), 120);
				String var42 = StatCollector.translateToLocalFormatted("achievement.requires",
				...
				this.drawGradientRect(var26 - 3, var27 - 3, var26 + var39 + 3, var27 + var30 + 12 + 3, -1073741824,
						-1073741824);
				this.fontRenderer.drawSplitString(var42, var26, var27 + 12, var39, -9416624);
			}

			this.fontRenderer.drawStringWithShadow(var36, var26, var27,
					this.statFileWriter.canUnlockAchievement(var32) ? (var32.getSpecial() ? -128 : -1)
