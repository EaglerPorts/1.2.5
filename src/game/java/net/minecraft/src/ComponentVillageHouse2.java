...
public class ComponentVillageHouse2 extends ComponentVillage {
	...
	public static ComponentVillageHouse2 findValidPlacement(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, 0, 0, 0, 10, 6, 7,
				var5);
		return canVillageGoDeeper(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentVillageHouse2(var6, var1, var7, var5)
				: null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		...
		this.placeBlockAtCurrentPosition(var1, Block.stairCompactPlanks.blockID,
				this.getMetadataWithOffset(Block.stairCompactPlanks.blockID, 3), 2, 1, 5, var3);
		this.placeBlockAtCurrentPosition(var1, Block.stairCompactPlanks.blockID,
				this.getMetadataWithOffset(Block.stairCompactPlanks.blockID, 1), 1, 1, 4, var3);
		int var4;
		int var5;
		...
		for (var4 = 6; var4 <= 8; ++var4) {
			if (this.getBlockIdAtCurrentPosition(var1, var4, 0, -1, var3) == 0
					&& this.getBlockIdAtCurrentPosition(var1, var4, -1, -1, var3) != 0) {
				this.placeBlockAtCurrentPosition(var1, Block.stairCompactCobblestone.blockID,
						this.getMetadataWithOffset(Block.stairCompactCobblestone.blockID, 3), var4, 0, -1, var3);
			}
		}
