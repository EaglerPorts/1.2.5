...
public class GuiMainMenu extends GuiScreen {
	...
	private String[] ts = EaglercraftVersion.getTitleString();
	...
	public void initGui() {
		...
		if (this.mc.hideQuitButton) {
			...
			this.controlList
					.add(new GuiButton(4, this.width / 2 + 2, var4 + 72, 98, 20, I18n.format("menu.editProfile")));
		}

		// 1.2.5 TODO: this.controlList.add(new GuiButtonLanguage(5, this.width / 2 - 124, var4 + 72));
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		this.drawString(this.fontRenderer, "Minecraft 1.2.5", 2, this.height - 20, 16777215);
