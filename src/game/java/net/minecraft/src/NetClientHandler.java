...
public class NetClientHandler extends NetHandler {
	...
	public void handleLogin(Packet1Login var1) {
		...
		this.worldClient = new WorldClient(this, new WorldSettings(0L, var1.serverMode, false, false, var1.terrainType),
				var1.field_48170_e, var1.difficultySetting);
	...
	public void handleVehicleSpawn(Packet23VehicleSpawn var1) {
		...
		if (var1.type == 10) {
			...
			var8 = new EntityFireball(this.worldClient, var2, var4, var6, (double) var1.speedX / 8000.0D,
					(double) var1.speedY / 8000.0D, (double) var1.speedZ / 8000.0D);
			var1.throwerEntityId = 0;
		} else if (var1.type == 64) {
			var8 = new EntitySmallFireball(this.worldClient, var2, var4, var6, (double) var1.speedX / 8000.0D,
					(double) var1.speedY / 8000.0D, (double) var1.speedZ / 8000.0D);
			var1.throwerEntityId = 0;
		...
		if (var8 != null) {
			...
			if (var1.throwerEntityId > 0) {
				...
				((Entity) var8).setVelocity((double) var1.speedX / 8000.0D, (double) var1.speedY / 8000.0D,
						(double) var1.speedZ / 8000.0D);
			}
		}
	...
	public void handleEntityExpOrb(Packet26EntityExpOrb var1) {
		EntityXPOrb var2 = new EntityXPOrb(this.worldClient, (double) var1.posX, (double) var1.posY, (double) var1.posZ,
				var1.xpValue);
	...
	public void func_48487_a(Packet51MapChunk var1) {
		this.worldClient.invalidateBlockReceiveRegion(var1.xCh << 4, 0, var1.zCh << 4, (var1.xCh << 4) + 15, 256,
				(var1.zCh << 4) + 15);
		...
		if (var2 != null) {
			...
			this.worldClient.markBlocksDirty(var1.xCh << 4, 0, var1.zCh << 4, (var1.xCh << 4) + 15, 256,
					(var1.zCh << 4) + 15);
	...
	public void handleKickDisconnect(Packet255KickDisconnect var1) {
		...
		this.mc.displayGuiScreen(
				new GuiDisconnected("disconnect.disconnected", "disconnect.genericReason", new Object[] { var1.reason }));
	}
	...
	public void handleCollect(Packet22Collect var1) {
		...
		if (var2 != null) {
			if (var2 instanceof EntityXPOrb) {
				this.worldClient.playSoundAtEntity(var2, "random.orb", 0.2F,
	...
	public void handleHandshake(Packet2Handshake var1) {
		...
		if (!var2) {
			...
			try {
				URL var4 = new URL("http://session.minecraft.net/game/joinserver.jsp?user=" + this.mc.session.username
				...
				this.netManager.networkShutdown("disconnect.genericReason",
						new Object[] { "Internal client error: " + var7.toString() });
			}
		}
	...
	public void handleRespawn(Packet9Respawn var1) {
		if (var1.respawnDimension != this.mc.thePlayer.dimension) {
			...
			this.worldClient = new WorldClient(this, new WorldSettings(0L, var1.creativeMode, false, false, var1.terrainType),
					var1.respawnDimension, var1.difficulty);
			this.worldClient.isRemote = true;
			this.mc.changeWorld1(this.worldClient);
	...
	public void handleOpenWindow(Packet100OpenWindow var1) {
		...
		switch (var1.inventoryType) {
			case 0:
				...
				break;
			case 1:
				var2.displayWorkbenchGUI(MathHelper.floor_double(var2.posX), MathHelper.floor_double(var2.posY),
