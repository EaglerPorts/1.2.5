...
public class BlockPistonExtension extends Block {
	...
	public int getBlockTextureFromSideAndMetadata(int var1, int var2) {
		...
		return var1 == var3
				? (this.headTexture >= 0 ? this.headTexture
						: ((var2 & 8) != 0 ? this.blockIndexInTexture - 1 : this.blockIndexInTexture))
				: (var1 == Facing.faceToSide[var3] ? 107 : 108);
	}
	...
	public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
		...
		int var7 = var1.getBlockId(var2 - Facing.offsetsXForSide[var6], var3 - Facing.offsetsYForSide[var6],
				var4 - Facing.offsetsZForSide[var6]);
		if (var7 != Block.pistonBase.blockID && var7 != Block.pistonStickyBase.blockID) {
			var1.setBlockWithNotify(var2, var3, var4, 0);
		} else {
			Block.blocksList[var7].onNeighborBlockChange(var1, var2 - Facing.offsetsXForSide[var6],
					var3 - Facing.offsetsYForSide[var6], var4 - Facing.offsetsZForSide[var6], var5);
		}
