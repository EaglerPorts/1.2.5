				...
				for (int var44 = 0; var44 < var10; ++var44) {
					...
					for (int var51 = 0; var51 < var9; ++var51) {
						...
						if (var51 == 0 || var55 != var22) {
							...
							var33 = this.lerp(var42, this.grad(this.permutations[var71 + 1], var38, var52, var45 - 1.0D),
									this.grad(this.permutations[var75 + 1], var38 - 1.0D, var52, var45 - 1.0D));
							var35 = this.lerp(var42, this.grad(this.permutations[var72 + 1], var38, var52 - 1.0D, var45 - 1.0D),
