...
public class BlockLeaves extends BlockLeavesBase {
	...
	public int getRenderColor(int var1) {
		return (var1 & 3) == 1 ? ColorizerFoliage.getFoliageColorPine()
				: ((var1 & 3) == 2 ? ColorizerFoliage.getFoliageColorBirch() : ColorizerFoliage.getFoliageColorBasic());
	}
	...
	public int getBlockTextureFromSideAndMetadata(int var1, int var2) {
		return (var2 & 3) == 1 ? this.blockIndexInTexture + 80
				: ((var2 & 3) == 3 ? this.blockIndexInTexture + 144 : this.blockIndexInTexture);
	}
