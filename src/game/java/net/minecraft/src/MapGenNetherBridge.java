...
public class MapGenNetherBridge extends MapGenStructure {
	...
	public MapGenNetherBridge() {
		this.spawnList.add(new SpawnListEntry(EntityBlaze::new, 10, 2, 3));
		this.spawnList.add(new SpawnListEntry(EntityPigZombie::new, 10, 4, 4));
		this.spawnList.add(new SpawnListEntry(EntityMagmaCube::new, 3, 4, 4));
	}
