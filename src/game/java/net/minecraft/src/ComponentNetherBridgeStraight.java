...
public class ComponentNetherBridgeStraight extends ComponentNetherBridgePiece {
	...
	public static ComponentNetherBridgeStraight createValidComponent(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -1, -3, 0, 5, 10,
				19, var5);
		return isAboveGround(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentNetherBridgeStraight(var6, var1, var7, var5)
				: null;
	}
