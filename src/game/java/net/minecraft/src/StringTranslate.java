...
public class StringTranslate {
	...
	private void loadLanguageList() {
		...
		try {
			BufferedReader var2 = new BufferedReader(new InputStreamReader(TexturePack.getResourceAsStream("/lang/languages.txt"), "UTF-8"));
	...
	private void loadLanguage(Properties var1, String var2) throws IOException {
		BufferedReader var3 = new BufferedReader(new InputStreamReader(TexturePack.getResourceAsStream("/lang/" + var2 + ".lang"), "UTF-8"));
