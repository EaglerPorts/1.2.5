...
public class WorldGenSpikes extends WorldGenerator {
	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		if (var1.isAirBlock(var3, var4, var5) && var1.getBlockId(var3, var4 - 1, var5) == this.replaceID) {
			...
			for (var8 = var3 - var7; var8 <= var3 + var7; ++var8) {
				for (var9 = var5 - var7; var9 <= var5 + var7; ++var9) {
					...
					if (var10 * var10 + var11 * var11 <= var7 * var7 + 1
							&& var1.getBlockId(var8, var4 - 1, var9) != this.replaceID) {
						return false;
					}
				}
			}
			...
			var13.setLocationAndAngles((double) ((float) var3 + 0.5F), (double) (var4 + var6), (double) ((float) var5 + 0.5F),
					var2.nextFloat() * 360.0F, 0.0F);
