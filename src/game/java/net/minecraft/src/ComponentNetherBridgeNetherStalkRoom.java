...
public class ComponentNetherBridgeNetherStalkRoom extends ComponentNetherBridgePiece {
	...
	public static ComponentNetherBridgeNetherStalkRoom createValidComponent(List var0, Random var1, int var2, int var3,
			int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -5, -3, 0, 13, 14,
				13, var5);
		return isAboveGround(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentNetherBridgeNetherStalkRoom(var6, var1, var7, var5)
				: null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		...
		for (var4 = 1; var4 <= 11; var4 += 2) {
			this.fillWithBlocks(var1, var3, var4, 10, 0, var4, 11, 0, Block.netherFence.blockID, Block.netherFence.blockID,
					false);
			this.fillWithBlocks(var1, var3, var4, 10, 12, var4, 11, 12, Block.netherFence.blockID, Block.netherFence.blockID,
					false);
			this.fillWithBlocks(var1, var3, 0, 10, var4, 0, 11, var4, Block.netherFence.blockID, Block.netherFence.blockID,
					false);
			this.fillWithBlocks(var1, var3, 12, 10, var4, 12, 11, var4, Block.netherFence.blockID, Block.netherFence.blockID,
					false);
		...
		for (var4 = 3; var4 <= 9; var4 += 2) {
			this.fillWithBlocks(var1, var3, 1, 7, var4, 1, 8, var4, Block.netherFence.blockID, Block.netherFence.blockID,
					false);
			this.fillWithBlocks(var1, var3, 11, 7, var4, 11, 8, var4, Block.netherFence.blockID, Block.netherFence.blockID,
					false);
		}
		...
		for (var5 = 0; var5 <= 6; ++var5) {
			...
			if (var6 >= 5 && var6 <= 8) {
				this.fillWithBlocks(var1, var3, 5, 5, var6, 7, var5 + 4, var6, Block.netherBrick.blockID,
						Block.netherBrick.blockID, false);
			} else if (var6 >= 9 && var6 <= 10) {
				this.fillWithBlocks(var1, var3, 5, 8, var6, 7, var5 + 4, var6, Block.netherBrick.blockID,
						Block.netherBrick.blockID, false);
			}
