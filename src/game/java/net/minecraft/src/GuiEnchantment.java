...
public class GuiEnchantment extends GuiContainer {
	...
	protected void mouseClicked(int var1, int var2, int var3) {
		...
		for (int var6 = 0; var6 < 3; ++var6) {
			...
			if (var7 >= 0 && var8 >= 0 && var7 < 108 && var8 < 19
					&& this.containerEnchantment.enchantItem(this.mc.thePlayer, var6)) {
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		GL11.glViewport((var7.getScaledWidth() - 320) / 2 * var7.scaleFactor,
				(var7.getScaledHeight() - 240) / 2 * var7.scaleFactor, 320 * var7.scaleFactor, 240 * var7.scaleFactor);
		...
		for (int var13 = 0; var13 < 3; ++var13) {
			...
			if (var15 == 0) {
				...
				if (this.mc.thePlayer.experienceLevel < var15 && !this.mc.thePlayer.capabilities.isCreativeMode) {
					...
					var18 = 4226832;
					var17.drawStringWithShadow(var16, var5 + 62 + 104 - var17.getStringWidth(var16), var6 + 16 + 19 * var13 + 7,
							var18);
				} else {
