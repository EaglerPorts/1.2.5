...
public class RenderEndPortal extends TileEntitySpecialRenderer {
	...
	public void func_40446_a(TileEntityEndPortal var1, double var2, double var4, double var6, float var8) {
		...
		for (int var14 = 0; var14 < 16; ++var14) {
			...
			GlStateManager.func_179105_a(GlStateManager.TexGen.S, GL11.GL_OBJECT_PLANE, this.func_40447_a(1.0F, 0.0F, 0.0F, 0.0F));
			GlStateManager.func_179105_a(GlStateManager.TexGen.T, GL11.GL_OBJECT_PLANE, this.func_40447_a(0.0F, 0.0F, 1.0F, 0.0F));
			GlStateManager.func_179105_a(GlStateManager.TexGen.R, GL11.GL_OBJECT_PLANE, this.func_40447_a(0.0F, 0.0F, 0.0F, 1.0F));
			GlStateManager.func_179105_a(GlStateManager.TexGen.Q, GL11.GL_EYE_PLANE, this.func_40447_a(0.0F, 1.0F, 0.0F, 0.0F));
