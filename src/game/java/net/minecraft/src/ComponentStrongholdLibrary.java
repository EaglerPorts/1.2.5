...
public class ComponentStrongholdLibrary extends ComponentStronghold {
	private static final StructurePieceTreasure[] field_35056_b = new StructurePieceTreasure[] {
	...
	public static ComponentStrongholdLibrary findValidPlacement(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -4, -1, 0, 14, 11,
				15, var5);
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		if (this.isLiquidInStructureBoundingBox(var1, var3)) {
			...
			this.fillWithRandomizedBlocks(var1, var3, 0, 0, 0, 13, var4 - 1, 14, true, var2,
					StructureStrongholdPieces.getStrongholdStones());
			this.placeDoor(var1, var2, var3, this.doorType, 4, 1, 0);
			this.randomlyFillWithBlocks(var1, var3, var2, 0.07F, 2, 1, 1, 11, 4, 13, Block.web.blockID, Block.web.blockID,
					false);
			...
			for (var7 = 1; var7 <= 13; ++var7) {
				if ((var7 - 1) % 4 == 0) {
					...
					if (this.isLargeRoom) {
						...
						this.fillWithBlocks(var1, var3, 12, 6, var7, 12, 9, var7, Block.planks.blockID, Block.planks.blockID,
								false);
					}
				} else {
					this.fillWithBlocks(var1, var3, 1, 1, var7, 1, 4, var7, Block.bookShelf.blockID, Block.bookShelf.blockID,
							false);
					this.fillWithBlocks(var1, var3, 12, 1, var7, 12, 4, var7, Block.bookShelf.blockID, Block.bookShelf.blockID,
							false);
					if (this.isLargeRoom) {
						this.fillWithBlocks(var1, var3, 1, 6, var7, 1, 9, var7, Block.bookShelf.blockID, Block.bookShelf.blockID,
								false);
						this.fillWithBlocks(var1, var3, 12, 6, var7, 12, 9, var7, Block.bookShelf.blockID, Block.bookShelf.blockID,
								false);
					}
				}
			}
			...
			for (var7 = 3; var7 < 12; var7 += 2) {
				this.fillWithBlocks(var1, var3, 3, 1, var7, 4, 3, var7, Block.bookShelf.blockID, Block.bookShelf.blockID,
						false);
				this.fillWithBlocks(var1, var3, 6, 1, var7, 7, 3, var7, Block.bookShelf.blockID, Block.bookShelf.blockID,
						false);
				this.fillWithBlocks(var1, var3, 9, 1, var7, 10, 3, var7, Block.bookShelf.blockID, Block.bookShelf.blockID,
						false);
			}
