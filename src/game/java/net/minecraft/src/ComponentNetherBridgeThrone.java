...
public class ComponentNetherBridgeThrone extends ComponentNetherBridgePiece {
	...
	public static ComponentNetherBridgeThrone createValidComponent(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -2, 0, 0, 7, 8, 9,
				var5);
		return isAboveGround(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentNetherBridgeThrone(var6, var1, var7, var5)
				: null;
	}
