...
public class ComponentVillageField2 extends ComponentVillage {
	...
	public static ComponentVillageField2 findValidPlacement(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, 0, 0, 0, 7, 4, 9,
				var5);
		return canVillageGoDeeper(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentVillageField2(var6, var1, var7, var5)
				: null;
	}
