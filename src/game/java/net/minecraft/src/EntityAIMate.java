		...
		if (var1 != null) {
			...
			for (int var3 = 0; var3 < 7; ++var3) {
				...
				this.theWorld.spawnParticle("heart",
						...
						this.theAnimal.posY + 0.5D + (double) (var2.nextFloat() * this.theAnimal.height), this.theAnimal.posZ
								+ (double) (var2.nextFloat() * this.theAnimal.width * 2.0F) - (double) this.theAnimal.width,
						var4, var6, var8);
			}
