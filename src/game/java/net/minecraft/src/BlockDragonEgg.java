	...
	private void fallIfPossible(World var1, int var2, int var3, int var4) {
		if (BlockSand.canFallBelow(var1, var2, var3 - 1, var4) && var3 >= 0) {
			...
			if (!BlockSand.fallInstantly
					&& var1.checkChunksExist(var2 - var8, var3 - var8, var4 - var8, var2 + var8, var3 + var8, var4 + var8)) {
				EntityFallingSand var9 = new EntityFallingSand(var1, (double) ((float) var2 + 0.5F),
						(double) ((float) var3 + 0.5F), (double) ((float) var4 + 0.5F), this.blockID);
				...
				for (int var5 = 0; var5 < 1000; ++var5) {
					...
					if (var1.getBlockId(var6, var7, var8) == 0) {
						...
						for (int var10 = 0; var10 < var9; ++var10) {
							...
							double var16 = (double) var6 + (double) (var2 - var6) * var11 + (var1.rand.nextDouble() - 0.5D) * 1.0D
									+ 0.5D;
							double var18 = (double) var7 + (double) (var3 - var7) * var11 + var1.rand.nextDouble() * 1.0D - 0.5D;
							double var20 = (double) var8 + (double) (var4 - var8) * var11 + (var1.rand.nextDouble() - 0.5D) * 1.0D
									+ 0.5D;
