...
public class BlockDispenser extends BlockContainer {
		...
		if (var11 != null) {
			...
			if (var12 == null) {
				...
				if (var12.itemID == Item.arrow.shiftedIndex) {
					...
					ItemMonsterPlacer.func_48440_a(var1, var12.getItemDamage(), var13 + (double) var9 * 0.3D, var15 - 0.3D,
							var17 + (double) var10 * 0.3D);
					var1.playAuxSFX(1002, var2, var3, var4, 0);
				} else if (var12.itemID == Item.fireballCharge.shiftedIndex) {
					EntitySmallFireball var22 = new EntitySmallFireball(var1, var13 + (double) var9 * 0.3D, var15,
							var17 + (double) var10 * 0.3D, (double) var9 + var5.nextGaussian() * 0.05D, var5.nextGaussian() * 0.05D,
							(double) var10 + var5.nextGaussian() * 0.05D);
	...
	public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
		if (!var1.isRemote && (var1.isBlockIndirectlyGettingPowered(var2, var3, var4)
				|| var1.isBlockIndirectlyGettingPowered(var2, var3 + 1, var4))) {
