...
public class ComponentStrongholdStairsStraight extends ComponentStronghold {
	...
	public static ComponentStrongholdStairsStraight findValidPlacement(List var0, Random var1, int var2, int var3,
			int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -1, -7, 0, 5, 11, 8,
				var5);
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		if (this.isLiquidInStructureBoundingBox(var1, var3)) {
			...
			this.fillWithRandomizedBlocks(var1, var3, 0, 0, 0, 4, 10, 7, true, var2,
			...
			for (int var5 = 0; var5 < 6; ++var5) {
				this.placeBlockAtCurrentPosition(var1, Block.stairCompactCobblestone.blockID, var4, 1, 6 - var5, 1 + var5,
						var3);
				this.placeBlockAtCurrentPosition(var1, Block.stairCompactCobblestone.blockID, var4, 2, 6 - var5, 1 + var5,
						var3);
				this.placeBlockAtCurrentPosition(var1, Block.stairCompactCobblestone.blockID, var4, 3, 6 - var5, 1 + var5,
						var3);
				if (var5 < 5) {
