...
public class RandomPositionGenerator {
	...
	private static Vec3D func_48621_c(EntityCreature var0, int var1, int var2, Vec3D var3) {
		...
		boolean var10;
		if (var0.hasHome()) {
			double var11 = var0.getHomePosition().getEuclideanDistanceTo(MathHelper.floor_double(var0.posX),
					MathHelper.floor_double(var0.posY), MathHelper.floor_double(var0.posZ)) + 4.0D;
