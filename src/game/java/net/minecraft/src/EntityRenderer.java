...
public class EntityRenderer {
	...
	public EntityRenderer(Minecraft var1) {
		...
		this.lightmapTexture = var1.renderEngine.allocateAndSetupTexture(new ImageData(16, 16, false));
	...
	public void updateRenderer() {
		...
		var1 = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(this.mc.renderViewEntity.posX),
				MathHelper.floor_double(this.mc.renderViewEntity.posY), MathHelper.floor_double(this.mc.renderViewEntity.posZ));
		...
		if (this.mc.renderViewEntity != null) {
			if (this.mc.theWorld != null) {
				...
				List var10 = this.mc.theWorld.getEntitiesWithinAABBExcludingEntity(this.mc.renderViewEntity,
						this.mc.renderViewEntity.boundingBox.addCoord(var7.xCoord * var2, var7.yCoord * var2, var7.zCoord * var2)
	...
	private void orientCamera(float var1) {
		...
		if (var2.isPlayerSleeping()) {
			...
			double var27 = (double) (this.thirdPersonDistanceTemp
					+ (this.thirdPersonDistance - this.thirdPersonDistanceTemp) * var1);
			float var13;
			float var28;
			if (this.mc.gameSettings.debugCamEnable) {
	...
	private void setupCameraTransform(float var1, int var2) {
		...
		GLU.gluPerspective(this.getFOVModifier(var1, true), (float) this.mc.displayWidth / (float) this.mc.displayHeight,
	...
	private void renderHand(float var1, int var2) {
		if (this.debugViewDirection <= 0) {
			...
			GLU.gluPerspective(this.getFOVModifier(var1, false), (float) this.mc.displayWidth / (float) this.mc.displayHeight,
					0.05F, this.farPlaneDistance * 2.0F);
			if (this.mc.playerController.func_35643_e()) {
			...
			if (this.mc.gameSettings.thirdPersonView == 0 && !this.mc.renderViewEntity.isPlayerSleeping()
					&& !this.mc.gameSettings.hideGUI && !this.mc.playerController.func_35643_e()) {
					...
					if (var20 > 0) {
						if (Block.blocksList[var20].blockMaterial == Material.lava) {
							this.mc.effectRenderer.addEffect(new EntitySmokeFX(var3, (double) ((float) var17 + var22),
									(double) ((float) var19 + 0.1F) - Block.blocksList[var20].minY, (double) ((float) var18 + var23),
									0.0D, 0.0D, 0.0D));
						} else {
							++var14;
			...
			for (int var20 = var45 - var16; var20 <= var45 + var16; ++var20) {
				for (int var21 = var43 - var16; var21 <= var43 + var16; ++var21) {
					...
					if (var25.canSpawnLightningBolt() || var25.getEnableSnow()) {
						...
						if (var27 != var28) {
							this.random
									.setSeed((long) (var21 * var21 * 3121 + var21 * 45238971 ^ var20 * var20 * 418711 + var20 * 13761));
							...
							if (var42.getWorldChunkManager().getTemperatureAtHeight(var31, var26) >= 0.15F) {
								...
								var32 = ((float) (this.rendererUpdateCount + var21 * var21 * 3121 + var21 * 45238971
										+ var20 * var20 * 418711 + var20 * 13761 & 31) + var1) / 32.0F * (3.0F + this.random.nextFloat());
	...
	private void updateFogColor(float var1) {
		...
		float var11;
		if (this.mc.gameSettings.renderDistance < 2) {
			Vec3D var10 = MathHelper.sin(var2.getCelestialAngleRadians(var1)) > 0.0F ? Vec3D.createVector(-1.0D, 0.0D, 0.0D)
					: Vec3D.createVector(1.0D, 0.0D, 0.0D);
		...
		double var14 = (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double) var1)
				* var2.worldProvider.getVoidFogYFactor();
			...
			if (var3.isPotionActive(Potion.blindness)) {
				...
				if (this.cloudFog) {
					...
					if (this.mc.theWorld.worldProvider.getWorldHasNoSky() && !var4) {
						double var13 = (double) ((var3.getBrightnessForRender(var2) & 15728640) >> 20) / 16.0D
								+ (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double) var2 + 4.0D) / 32.0D;
						if (var13 < 1.0D) {
							if (var13 < 0.0D) {
								var13 = 0.0D;
							}
