...
public class MapGenCaves extends MapGenBase {
	protected void generateLargeCaveNode(long var1, int var3, int var4, byte[] var5, double var6, double var8,
			double var10) {
		this.generateCaveNode(var1, var3, var4, var5, var6, var8, var10, 1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F,
				-1, -1, 0.5D);
	}

	protected void generateCaveNode(long var1, int var3, int var4, byte[] var5, double var6, double var8, double var10,
		...
		for (boolean var28 = var25.nextInt(6) == 0; var15 < var16; ++var15) {
			...
			if (!var54 && var15 == var27 && var12 > 1.0F && var16 > 0) {
				this.generateCaveNode(var25.nextLong(), var3, var4, var5, var6, var8, var10, var25.nextFloat() * 0.5F + 0.5F,
						var13 - (float) Math.PI * 0.5F, var14 / 3.0F, var15, var16, 1.0D);
				this.generateCaveNode(var25.nextLong(), var3, var4, var5, var6, var8, var10, var25.nextFloat() * 0.5F + 0.5F,
						var13 + (float) Math.PI * 0.5F, var14 / 3.0F, var15, var16, 1.0D);
				return;
			}
			...
			if (var54 || var25.nextInt(4) != 0) {
				...
				if (var6 >= var19 - 16.0D - var29 * 2.0D && var10 >= var21 - 16.0D - var29 * 2.0D
						&& var6 <= var19 + 16.0D + var29 * 2.0D && var10 <= var21 + 16.0D + var29 * 2.0D) {
											...
											if (var53 == Block.stone.blockID || var53 == Block.dirt.blockID || var53 == Block.grass.blockID) {
												if (var50 < 10) {
													...
													if (var49 && var5[var48 - 1] == Block.dirt.blockID) {
														var5[var48 - 1] = this.worldObj.getBiomeGenForCoords(var42 + var3 * 16,
																var45 + var4 * 16).topBlock;
													}
												}
											}
										}
	...
	protected void recursiveGenerate(World var1, int var2, int var3, int var4, int var5, byte[] var6) {
		...
		for (int var8 = 0; var8 < var7; ++var8) {
			...
			for (int var16 = 0; var16 < var15; ++var16) {
				...
				this.generateCaveNode(this.rand.nextLong(), var4, var5, var6, var9, var11, var13, var19, var17, var18, 0, 0,
						1.0D);
			}
		}
