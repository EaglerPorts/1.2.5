...
public class GuiOptions extends GuiScreen {
	...
	public void initGui() {
		...
		extraOpts.add(new GuiButton(101, this.width / 2 - 100, this.height / 6 + 96 - 6, var1.translateKey("options.video")));
		extraOpts.add(new GuiButton(100, this.width / 2 - 100, this.height / 6 + 120 - 6, var1.translateKey("options.controls")));
		extraOpts.add(new GuiButton(102, this.width / 2 - 100, this.height / 6 + 144 - 6, var1.translateKey("options.language")));

		extraOpts.add(new GuiButton(103, 0, 0, I18n.format("menu.mods") + I18n.format("more")));
		...
		for (GuiButton extraOpt : extraOpts) {
			...
			if (extraOpt.id == 102) opt.enabled = false;
