...
public class ComponentNetherBridgeCorridor extends ComponentNetherBridgePiece {
	...
	public static ComponentNetherBridgeCorridor createValidComponent(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -1, 0, 0, 5, 7, 5,
				var5);
		return isAboveGround(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentNetherBridgeCorridor(var6, var1, var7, var5)
				: null;
	}
