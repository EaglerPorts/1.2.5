...
public class BiomeGenJungle extends BiomeGenBase {
	public BiomeGenJungle(int var1) {
		...
		this.spawnableMonsterList.add(new SpawnListEntry(EntityOcelot::new, 2, 1, 1));
		this.spawnableCreatureList.add(new SpawnListEntry(EntityChicken::new, 10, 4, 4));
	}

	public WorldGenerator getRandomWorldGenForTrees(Random var1) {
		return (WorldGenerator) (var1.nextInt(10) == 0 ? this.worldGenBigTree
				: (var1.nextInt(2) == 0 ? new WorldGenShrub(3, 0)
						: (var1.nextInt(3) == 0 ? new WorldGenHugeTrees(false, 10 + var1.nextInt(20), 3, 3)
								: new WorldGenTrees(false, 4 + var1.nextInt(7), 3, 3, true))));
	}

	public WorldGenerator func_48410_b(Random var1) {
		return var1.nextInt(4) == 0 ? new WorldGenTallGrass(Block.tallGrass.blockID, 2)
