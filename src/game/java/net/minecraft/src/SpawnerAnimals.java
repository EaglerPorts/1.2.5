...
public final class SpawnerAnimals {
	...
	protected static final EntitySupplier[] nightSpawnEntities = new EntitySupplier[] { EntitySpider::new, EntityZombie::new,
			EntitySkeleton::new };
	...
	public static final int performSpawning(World var0, boolean var1, boolean var2) {
		if (!var1 && !var2) {
			...
			label126: for (int var33 = 0; var33 < var6; ++var33) {
				EnumCreatureType var34 = var32[var33];
				if ((!var34.getPeacefulCreature() || var2) && (var34.getPeacefulCreature() || var1)
						&& var0.countEntities(var34.getCreatureClass()) <= var34.getMaxNumberOfCreature()
								...
								if (canCreatureTypeSpawnAtLocation(var34, var0, var17, var18, var19)) {
									...
									if (var0.getClosestPlayer((double) var23, (double) var24, (double) var25, 24.0D) == null) {
										...
										if (var29 >= 576.0F) {
											...
											EntityLiving var38;
											try {
												var38 = (EntityLiving) var21.entityClass.createEntity(var0);
	...
	public static boolean canCreatureTypeSpawnAtLocation(EnumCreatureType var0, World var1, int var2, int var3,
			int var4) {
		if (var0.getCreatureMaterial() == Material.water) {
			...
			return Block.isNormalCube(var5) && var5 != Block.bedrock.blockID && !var1.isBlockNormalCube(var2, var3, var4)
					&& !var1.getBlockMaterial(var2, var3, var4).isLiquid() && !var1.isBlockNormalCube(var2, var3 + 1, var4);
		}
	}
	...
	public static void performWorldGenSpawning(World var0, BiomeGenBase var1, int var2, int var3, int var4, int var5,
			Random var6) {
				...
				for (int var14 = 0; var14 < var9; ++var14) {
					...
					for (int var16 = 0; !var15 && var16 < 4; ++var16) {
						...
						if (canCreatureTypeSpawnAtLocation(EnumCreatureType.creature, var0, var10, var17, var11)) {
							...
							EntityLiving var21;
							try {
								var21 = (EntityLiving) var8.entityClass.createEntity(var0);
							} catch (Exception var23) {
								var23.printStackTrace();
								continue;
							}

							var21.setLocationAndAngles((double) var18, (double) var19, (double) var20, var6.nextFloat() * 360.0F,
									0.0F);
						...
						for (var11 += var6.nextInt(5) - var6.nextInt(5); var10 < var2 || var10 >= var2 + var4 || var11 < var3
								|| var11 >= var3 + var4; var11 = var13 + var6.nextInt(5) - var6.nextInt(5)) {
