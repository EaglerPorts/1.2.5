...
public class ComponentNetherBridgeCorridor3 extends ComponentNetherBridgePiece {
	...
	public static ComponentNetherBridgeCorridor3 createValidComponent(List var0, Random var1, int var2, int var3,
			int var4, int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, -1, -7, 0, 5, 14,
				10, var5);
		return isAboveGround(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentNetherBridgeCorridor3(var6, var1, var7, var5)
				: null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		...
		for (int var5 = 0; var5 <= 9; ++var5) {
			...
			int var8 = var5;
			this.fillWithBlocks(var1, var3, 0, 0, var5, 4, var6, var5, Block.netherBrick.blockID, Block.netherBrick.blockID,
					false);
			...
			this.fillWithBlocks(var1, var3, 0, var7, var5, 4, var7, var5, Block.netherBrick.blockID,
					Block.netherBrick.blockID, false);
			this.fillWithBlocks(var1, var3, 0, var6 + 1, var5, 0, var7 - 1, var5, Block.netherBrick.blockID,
					Block.netherBrick.blockID, false);
			this.fillWithBlocks(var1, var3, 4, var6 + 1, var5, 4, var7 - 1, var5, Block.netherBrick.blockID,
					Block.netherBrick.blockID, false);
			if ((var5 & 1) == 0) {
				this.fillWithBlocks(var1, var3, 0, var6 + 2, var5, 0, var6 + 3, var5, Block.netherFence.blockID,
						Block.netherFence.blockID, false);
				this.fillWithBlocks(var1, var3, 4, var6 + 2, var5, 4, var6 + 3, var5, Block.netherFence.blockID,
						Block.netherFence.blockID, false);
			}
