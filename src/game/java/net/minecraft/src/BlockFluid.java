...
public abstract class BlockFluid extends Block {
	...
	public boolean isBlockSolid(IBlockAccess var1, int var2, int var3, int var4, int var5) {
		...
		return var6 == this.blockMaterial ? false
				: (var5 == 1 ? true : (var6 == Material.ice ? false : super.isBlockSolid(var1, var2, var3, var4, var5)));
	}
	...
	public boolean shouldSideBeRendered(IBlockAccess var1, int var2, int var3, int var4, int var5) {
		...
		return var6 == this.blockMaterial ? false
				: (var5 == 1 ? true
						: (var6 == Material.ice ? false : super.shouldSideBeRendered(var1, var2, var3, var4, var5)));
	}
	...
	public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5) {
		...
		if (this.blockMaterial == Material.water) {
			if (var5.nextInt(10) == 0) {
				...
				if (var6 <= 0 || var6 >= 8) {
					var1.spawnParticle("suspended", (double) ((float) var2 + var5.nextFloat()),
							(double) ((float) var3 + var5.nextFloat()), (double) ((float) var4 + var5.nextFloat()), 0.0D, 0.0D, 0.0D);
				}
			}
			...
			for (var6 = 0; var6 < 0; ++var6) {
				...
				if (var1.getBlockMaterial(var8, var3, var9) == Material.air
						&& (var1.getBlockMaterial(var8, var3 - 1, var9).blocksMovement()
								|| var1.getBlockMaterial(var8, var3 - 1, var9).isLiquid())) {
		...
		if (this.blockMaterial == Material.lava && var1.getBlockMaterial(var2, var3 + 1, var4) == Material.air
				&& !var1.isBlockOpaqueCube(var2, var3 + 1, var4)) {
			if (var5.nextInt(100) == 0) {
				...
				var1.playSoundEffect(var21, var22, var23, "liquid.lavapop", 0.2F + var5.nextFloat() * 0.2F,
						0.9F + var5.nextFloat() * 0.15F);
			}

			if (var5.nextInt(200) == 0) {
				var1.playSoundEffect((double) var2, (double) var3, (double) var4, "liquid.lava", 0.2F + var5.nextFloat() * 0.2F,
						0.9F + var5.nextFloat() * 0.15F);
			}
		}

		if (var5.nextInt(10) == 0 && var1.isBlockNormalCube(var2, var3 - 1, var4)
				&& !var1.getBlockMaterial(var2, var3 - 2, var4).blocksMovement()) {
			var21 = (double) ((float) var2 + var5.nextFloat());
