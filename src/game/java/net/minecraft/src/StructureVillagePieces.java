...
public class StructureVillagePieces {
	public static ArrayList getStructureVillageWeightedPieceList(Random var0, int var1) {
		...
		var2.add(new StructureVillagePieceWeight(ComponentVillageHouse4_Garden.class, 4,
				MathHelper.getRandomIntegerInRange(var0, 2 + var1, 4 + var1 * 2)));
		var2.add(new StructureVillagePieceWeight(ComponentVillageChurch.class, 20,
				MathHelper.getRandomIntegerInRange(var0, 0 + var1, 1 + var1)));
		var2.add(new StructureVillagePieceWeight(ComponentVillageHouse1.class, 20,
				MathHelper.getRandomIntegerInRange(var0, 0 + var1, 2 + var1)));
		var2.add(new StructureVillagePieceWeight(ComponentVillageWoodHut.class, 3,
				MathHelper.getRandomIntegerInRange(var0, 2 + var1, 5 + var1 * 3)));
		...
		var2.add(new StructureVillagePieceWeight(ComponentVillageField.class, 3,
				MathHelper.getRandomIntegerInRange(var0, 1 + var1, 4 + var1)));
		...
		var2.add(new StructureVillagePieceWeight(ComponentVillageHouse2.class, 15,
				MathHelper.getRandomIntegerInRange(var0, 0, 1 + var1)));
		var2.add(new StructureVillagePieceWeight(ComponentVillageHouse3.class, 8,
				MathHelper.getRandomIntegerInRange(var0, 0 + var1, 3 + var1 * 2)));
	...
	private static ComponentVillage getVillageComponentFromWeightedPiece(StructureVillagePieceWeight var0, List var1,
			Random var2, int var3, int var4, int var5, int var6, int var7) {
	...
	private static ComponentVillage getNextVillageComponent(ComponentVillageStartPiece var0, List var1, Random var2,
			...
			while (var9 < 5) {
				...
				while (var11.hasNext()) {
					...
					if (var10 < 0) {
						...
						ComponentVillage var13 = getVillageComponentFromWeightedPiece(var12, var1, var2, var3, var4, var5, var6,
								var7);
						if (var13 != null) {
	...
	private static StructureComponent getNextVillageStructureComponent(ComponentVillageStartPiece var0, List var1,
			Random var2, int var3, int var4, int var5, int var6, int var7) {
		if (var7 > 50) {
			return null;
		} else if (Math.abs(var3 - var0.getBoundingBox().minX) <= 112
				&& Math.abs(var5 - var0.getBoundingBox().minZ) <= 112) {
	...
	private static StructureComponent getNextComponentVillagePath(ComponentVillageStartPiece var0, List var1, Random var2,
			int var3, int var4, int var5, int var6, int var7) {
		if (var7 > 3 + var0.terrainType) {
			...
			if (var8 != null && var8.minY > 10) {
				...
				if (var0.getWorldChunkManager().areBiomesViable(var10, var11, var14 / 2 + 4,
	...
	static StructureComponent getNextStructureComponent(ComponentVillageStartPiece var0, List var1, Random var2, int var3,
			int var4, int var5, int var6, int var7) {
		return getNextVillageStructureComponent(var0, var1, var2, var3, var4, var5, var6, var7);
	}

	static StructureComponent getNextStructureComponentVillagePath(ComponentVillageStartPiece var0, List var1,
			Random var2, int var3, int var4, int var5, int var6, int var7) {
