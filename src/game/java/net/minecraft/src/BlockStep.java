...
public class BlockStep extends Block {
						...
						: (var3 == 2 ? 4
								: (var3 == 3 ? 16
										: (var3 == 4 ? Block.brick.blockIndexInTexture
												: (var3 == 5 ? Block.stoneBrick.blockIndexInTexture : 6)))));
	}
	...
	public boolean shouldSideBeRendered(IBlockAccess var1, int var2, int var3, int var4, int var5) {
		...
		if (var5 != 1 && var5 != 0 && !super.shouldSideBeRendered(var1, var2, var3, var4, var5)) {
			...
			return !var9
					? (var5 == 1 ? true
							: (var5 == 0 && super.shouldSideBeRendered(var1, var2, var3, var4, var5) ? true
									: var1.getBlockId(var2, var3, var4) != this.blockID
											|| (var1.getBlockMetadata(var2, var3, var4) & 8) != 0))
					: (var5 == 0 ? true
							: (var5 == 1 && super.shouldSideBeRendered(var1, var2, var3, var4, var5) ? true
									: var1.getBlockId(var2, var3, var4) != this.blockID
											|| (var1.getBlockMetadata(var2, var3, var4) & 8) == 0));
		}
	}
