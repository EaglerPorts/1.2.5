...
public class BlockStem extends BlockFlower {
	...
	public int func_35296_f(IBlockAccess var1, int var2, int var3, int var4) {
		...
		return var5 < 7 ? -1
				: (var1.getBlockId(var2 - 1, var3, var4) == this.fruitType.blockID ? 0
						: (var1.getBlockId(var2 + 1, var3, var4) == this.fruitType.blockID ? 1
								: (var1.getBlockId(var2, var3, var4 - 1) == this.fruitType.blockID ? 2
										: (var1.getBlockId(var2, var3, var4 + 1) == this.fruitType.blockID ? 3 : -1))));
	}
		...
		if (!var1.isRemote) {
			...
			for (int var9 = 0; var9 < 3; ++var9) {
				if (var1.rand.nextInt(15) <= var5) {
					...
					EntityItem var14 = new EntityItem(var1, (double) ((float) var2 + var11), (double) ((float) var3 + var12),
							(double) ((float) var4 + var13), new ItemStack(var8));
