...
public class StructureStrongholdPieces {
	...
	private static ComponentStronghold getStrongholdComponentFromWeightedPiece(Class var0, List var1, Random var2,
	...
	private static ComponentStronghold getNextComponent(ComponentStrongholdStairs2 var0, List var1, Random var2, int var3,
			int var4, int var5, int var6, int var7) {
		if (!canAddStructurePieces()) {
			return null;
		} else {
			if (strongComponentType != null) {
				ComponentStronghold var8 = getStrongholdComponentFromWeightedPiece(strongComponentType, var1, var2, var3, var4,
						var5, var6, var7);
				strongComponentType = null;
				if (var8 != null) {
					return var8;
			...
			while (var13 < 5) {
				...
				while (var10.hasNext()) {
					...
					if (var9 < 0) {
						...
						ComponentStronghold var12 = getStrongholdComponentFromWeightedPiece(var11.pieceClass, var1, var2, var3,
								var4, var5, var6, var7);
						if (var12 != null) {
	...
	private static StructureComponent getNextValidComponent(ComponentStrongholdStairs2 var0, List var1, Random var2,
			int var3, int var4, int var5, int var6, int var7) {
		if (var7 > 50) {
			return null;
	...
	static StructureComponent getNextValidComponentAccess(ComponentStrongholdStairs2 var0, List var1, Random var2,
			int var3, int var4, int var5, int var6, int var7) {
