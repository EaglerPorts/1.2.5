	...
	public void doExplosionA() {
		...
		for (int var11 = 0; var11 < var9.size(); ++var11) {
			...
			if (var13 <= 1.0D) {
				...
				var33.attackEntityFrom(DamageSource.explosion,
						(int) ((var36 * var36 + var36) / 2.0D * 8.0D * (double) this.explosionSize + 1.0D));
		...
		for (var3 = var2.size() - 1; var3 >= 0; --var3) {
			...
			if (var8 > 0) {
				Block.blocksList[var8].dropBlockAsItemWithChance(this.worldObj, var5, var6, var7,
						this.worldObj.getBlockMetadata(var5, var6, var7), 0.3F, 0);
