...
public class AnvilSaveConverter extends SaveFormatOld {
	public AnvilSaveConverter(VFile2 var1) {
		super(var1);
	}
	...
	public boolean convertMapFormat(String var1, IProgressUpdate var2) {
		...
		VFile2 var6 = new VFile2(this.savesDirectory, var1);
		...
		this.func_48428_a(new VFile2(var6, "region"), var3, (WorldChunkManager)var11, 0, var9, var2);
		this.func_48428_a(new VFile2(var7, "region"), var4, new WorldChunkManagerHell(BiomeGenBase.hell, 1.0F, 0.0F), var3.size(), var9, var2);
		this.func_48428_a(new VFile2(var8, "region"), var5, new WorldChunkManagerHell(BiomeGenBase.sky, 0.5F, 0.0F), var3.size() + var4.size(), var9, var2);
	...
	private void func_48428_a(VFile2 var1, ArrayList var2, WorldChunkManager var3, int var4, int var5, IProgressUpdate var6) {
		Iterator var7 = var2.iterator();

		while(var7.hasNext()) {
			VFile2 var8 = (VFile2)var7.next();
	...
	private void func_48430_a(VFile2 var1, VFile2 var2, WorldChunkManager var3, int var4, int var5, IProgressUpdate var6) {
		try {
			String var7 = var2.getName();
			RegionFile var8 = new RegionFile(var2);
			RegionFile var9 = new RegionFile(new VFile2(var1, var7.substring(0, var7.length() - ".mcr".length()) + ".mca"));
	...
	private void func_48432_a(VFile2 var1, ArrayList var2) {
		VFile2 var3 = new VFile2(var1, "region");
		VFile2[] var4 = var3.listFiles(new AnvilSaveConverterFileFilter(this));
		if(var4 != null) {
			VFile2[] var5 = var4;
			int var6 = var4.length;

			for(int var7 = 0; var7 < var6; ++var7) {
				VFile2 var8 = var5[var7];
				var2.add(var8);
			}
		}
