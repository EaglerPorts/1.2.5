...
public class TileEntityRendererPiston extends TileEntitySpecialRenderer {
	...
	public void renderPiston(TileEntityPiston var1, double var2, double var4, double var6, float var8) {
		...
		if (var9 != null && var1.getProgress(var8) < 1.0F) {
			...
			var10.setTranslationD((double) ((float) var2 - (float) var1.xCoord + var1.getOffsetX(var8)),
					(double) ((float) var4 - (float) var1.yCoord + var1.getOffsetY(var8)),
					(double) ((float) var6 - (float) var1.zCoord + var1.getOffsetZ(var8)));
			...
			if (var9 == Block.pistonExtension && var1.getProgress(var8) < 0.5F) {
				...
				this.blockRenderer.renderPistonExtensionAllFaces(Block.pistonExtension, var1.xCoord, var1.yCoord, var1.zCoord,
						var1.getProgress(var8) < 0.5F);
				Block.pistonExtension.clearHeadTexture();
				var10.setTranslationD((double) ((float) var2 - (float) var1.xCoord),
						(double) ((float) var4 - (float) var1.yCoord), (double) ((float) var6 - (float) var1.zCoord));
