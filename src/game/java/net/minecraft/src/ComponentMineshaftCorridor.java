...
public class ComponentMineshaftCorridor extends StructureComponent {
	...
	public void buildComponent(StructureComponent var1, List var2, Random var3) {
		...
		switch (this.coordBaseMode) {
			case 0:
				if (var5 <= 1) {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.minX,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.maxZ + 1, this.coordBaseMode, var4);
				} else if (var5 == 2) {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.minX - 1,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.maxZ - 3, 1, var4);
				} else {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.maxX + 1,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.maxZ - 3, 3, var4);
				}
				break;
			case 1:
				if (var5 <= 1) {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.minX - 1,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, var4);
				} else if (var5 == 2) {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.minX,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.minZ - 1, 2, var4);
				} else {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.minX,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.maxZ + 1, 0, var4);
				}
				break;
			case 2:
				if (var5 <= 1) {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.minX,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.minZ - 1, this.coordBaseMode, var4);
				} else if (var5 == 2) {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.minX - 1,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.minZ, 1, var4);
				} else {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.maxX + 1,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.minZ, 3, var4);
				}
				break;
			case 3:
				if (var5 <= 1) {
					...
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.maxX - 3,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.minZ - 1, 2, var4);
				} else {
					StructureMineshaftPieces.getNextComponent(var1, var2, var3, this.boundingBox.maxX - 3,
							this.boundingBox.minY - 1 + var3.nextInt(3), this.boundingBox.maxZ + 1, 0, var4);
		...
		if (var4 < 8) {
			...
			if (this.coordBaseMode != 2 && this.coordBaseMode != 0) {
				for (var6 = this.boundingBox.minX + 3; var6 + 3 <= this.boundingBox.maxX; var6 += 5) {
					var7 = var3.nextInt(5);
					if (var7 == 0) {
						StructureMineshaftPieces.getNextComponent(var1, var2, var3, var6, this.boundingBox.minY,
		...
		if (this.isLiquidInStructureBoundingBox(var1, var3)) {
			...
			for (var9 = 0; var9 < this.sectionCount; ++var9) {
				...
				if (var2.nextInt(100) == 0) {
					this.createTreasureChestAtCurrentPosition(var1, var3, var2, 2, 0, var10 - 1,
							StructureMineshaftPieces.getTreasurePieces(), 3 + var2.nextInt(4));
				}

				if (var2.nextInt(100) == 0) {
					this.createTreasureChestAtCurrentPosition(var1, var3, var2, 0, 0, var10 + 1,
							StructureMineshaftPieces.getTreasurePieces(), 3 + var2.nextInt(4));
				}
			...
			if (this.hasRails) {
				for (var9 = 0; var9 <= var8; ++var9) {
					...
					if (var10 > 0 && Block.opaqueCubeLookup[var10]) {
						this.randomlyPlaceBlock(var1, var3, var2, 0.7F, 1, 0, var9, Block.rail.blockID,
								this.getMetadataWithOffset(Block.rail.blockID, 0));
					}
				}
			}
