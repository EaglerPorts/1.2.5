...
public class ComponentVillageWoodHut extends ComponentVillage {
	...
	public static ComponentVillageWoodHut findValidPlacement(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, 0, 0, 0, 4, 6, 5,
				var5);
		return canVillageGoDeeper(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentVillageWoodHut(var6, var1, var7, var5)
				: null;
	}
