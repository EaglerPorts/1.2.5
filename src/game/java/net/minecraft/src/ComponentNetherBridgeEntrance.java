...
public class ComponentNetherBridgeEntrance extends ComponentNetherBridgePiece {
	...
	public static ComponentNetherBridgeEntrance createValidComponent(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		...
		return isAboveGround(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentNetherBridgeEntrance(var6, var1, var7, var5)
				: null;
	}
