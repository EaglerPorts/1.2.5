...
abstract class ComponentVillage extends StructureComponent {
	...
	protected StructureComponent getNextComponentNN(ComponentVillageStartPiece var1, List var2, Random var3, int var4,
			int var5) {
		switch (this.coordBaseMode) {
			case 0:
				return StructureVillagePieces.getNextStructureComponent(var1, var2, var3, this.boundingBox.minX - 1,
						this.boundingBox.minY + var4, this.boundingBox.minZ + var5, 1, this.getComponentType());
			case 1:
				return StructureVillagePieces.getNextStructureComponent(var1, var2, var3, this.boundingBox.minX + var5,
	...
	protected StructureComponent getNextComponentPP(ComponentVillageStartPiece var1, List var2, Random var3, int var4,
			int var5) {
		switch (this.coordBaseMode) {
			case 0:
				return StructureVillagePieces.getNextStructureComponent(var1, var2, var3, this.boundingBox.maxX + 1,
