...
public class RenderDragon extends RenderLiving {
	...
	protected void func_40280_a(EntityDragon var1, float var2, float var3, float var4, float var5, float var6,
			float var7) {
	...
	public void renderDragon(EntityDragon var1, double var2, double var4, double var6, float var8, float var9) {
		...
		if (var1.healingEnderCrystal != null) {
			...
			float var12 = (float) (var1.healingEnderCrystal.posX - var1.posX
					- (var1.prevPosX - var1.posX) * (double) (1.0F - var9));
			float var13 = (float) ((double) var11 + var1.healingEnderCrystal.posY - 1.0D - var1.posY
					- (var1.prevPosY - var1.posY) * (double) (1.0F - var9));
			float var14 = (float) (var1.healingEnderCrystal.posZ - var1.posZ
					- (var1.prevPosZ - var1.posZ) * (double) (1.0F - var9));
			...
			GL11.glRotatef((float) (-Math.atan2((double) var14, (double) var12)) * 180.0F / (float) Math.PI - 90.0F, 0.0F,
					1.0F, 0.0F);
			GL11.glRotatef((float) (-Math.atan2((double) var15, (double) var13)) * 180.0F / (float) Math.PI - 90.0F, 1.0F,
					0.0F, 0.0F);
			...
			float var19 = MathHelper.sqrt_float(var12 * var12 + var13 * var13 + var14 * var14) / 32.0F
					- ((float) var1.ticksExisted + var9) * 0.01F;
			var17.startDrawing(5);
			byte var20 = 8;

			for (int var21 = 0; var21 <= var20; ++var21) {
				float var22 = MathHelper.sin((float) (var21 % var20) * (float) Math.PI * 2.0F / (float) var20)
						* (12.0F / 16.0F);
				float var23 = MathHelper.cos((float) (var21 % var20) * (float) Math.PI * 2.0F / (float) var20)
						* (12.0F / 16.0F);
	...
	protected void renderModel(EntityLiving var1, float var2, float var3, float var4, float var5, float var6,
			float var7) {
