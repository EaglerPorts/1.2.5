			...
			for (int var7 = 0; var7 < var6.getSizeInventory(); ++var7) {
				...
				if (var8 != null) {
					...
					while (var8.stackSize > 0) {
						...
						EntityItem var13 = new EntityItem(var1, (double) ((float) var2 + var9), (double) ((float) var3 + var10),
								(double) ((float) var4 + var11), new ItemStack(var8.itemID, var12, var8.getItemDamage()));
						float var14 = 0.05F;
