...
public class ComponentVillageHouse4_Garden extends ComponentVillage {
	...
	public static ComponentVillageHouse4_Garden findValidPlacement(List var0, Random var1, int var2, int var3, int var4,
			int var5, int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, 0, 0, 0, 5, 6, 5,
				var5);
		return StructureComponent.findIntersecting(var0, var7) != null ? null
				: new ComponentVillageHouse4_Garden(var6, var1, var7, var5);
	}
