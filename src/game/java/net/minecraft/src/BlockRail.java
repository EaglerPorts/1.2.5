...
public class BlockRail extends Block {
	...
	public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
		if (!var1.isRemote) {
			...
			if (var8) {
				...
				var9 = var9 || this.isNeighborRailPowered(var1, var2, var3, var4, var6, true, 0)
						|| this.isNeighborRailPowered(var1, var2, var3, var4, var6, false, 0);
				boolean var10 = false;
				if (var9 && (var6 & 8) == 0) {
	...
	private void refreshTrackShape(World var1, int var2, int var3, int var4, boolean var5) {
		if (!var1.isRemote) {
			(new RailLogic(this, var1, var2, var3, var4))
					.refreshTrackShape(var1.isBlockIndirectlyGettingPowered(var2, var3, var4), var5);
		}
	}
	...
	private boolean isNeighborRailPowered(World var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
		if (var7 >= 8) {
			...
			return this.isRailPassingPower(var1, var2, var3, var4, var6, var7, var8) ? true
					: var9 && this.isRailPassingPower(var1, var2, var3 - 1, var4, var6, var7, var8);
		}
	}
