...
public class ComponentVillageHall extends ComponentVillage {
	...
	public static ComponentVillageHall findValidPlacement(List var0, Random var1, int var2, int var3, int var4, int var5,
			int var6) {
		StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(var2, var3, var4, 0, 0, 0, 9, 7, 11,
				var5);
		return canVillageGoDeeper(var7) && StructureComponent.findIntersecting(var0, var7) == null
				? new ComponentVillageHall(var6, var1, var7, var5)
				: null;
	}
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		...
		this.placeBlockAtCurrentPosition(var1, Block.stairCompactPlanks.blockID,
				this.getMetadataWithOffset(Block.stairCompactPlanks.blockID, 3), 2, 1, 4, var3);
		this.placeBlockAtCurrentPosition(var1, Block.stairCompactPlanks.blockID,
				this.getMetadataWithOffset(Block.stairCompactPlanks.blockID, 1), 1, 1, 3, var3);
