...
public class BlockSnow extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World var1, int var2, int var3, int var4) {
		...
		return var5 >= 3 ? AxisAlignedBB.getBoundingBoxFromPool((double) var2 + this.minX, (double) var3 + this.minY,
				(double) var4 + this.minZ, (double) var2 + this.maxX, (double) ((float) var3 + 0.5F), (double) var4 + this.maxZ)
				: null;
	}
	...
	public boolean canPlaceBlockAt(World var1, int var2, int var3, int var4) {
		...
		return var5 != 0 && (var5 == Block.leaves.blockID || Block.blocksList[var5].isOpaqueCube())
				? var1.getBlockMaterial(var2, var3 - 1, var4).blocksMovement()
				: false;
	}
	...
	public void harvestBlock(World var1, EntityPlayer var2, int var3, int var4, int var5, int var6) {
		...
		EntityItem var15 = new EntityItem(var1, (double) var3 + var9, (double) var4 + var11, (double) var5 + var13,
