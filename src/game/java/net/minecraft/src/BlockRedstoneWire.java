...
public class BlockRedstoneWire extends Block {
	...
	public boolean canPlaceBlockAt(World var1, int var2, int var3, int var4) {
		return var1.isBlockNormalCube(var2, var3 - 1, var4)
				|| var1.getBlockId(var2, var3 - 1, var4) == Block.glowStone.blockID;
	}
	...
	private void calculateCurrentChanges(World var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		if (var10) {
			...
			for (var11 = 0; var11 < 4; ++var11) {
				...
				} else if (!var1.isBlockNormalCube(var12, var3, var13)
	...
	public boolean isPoweringTo(IBlockAccess var1, int var2, int var3, int var4, int var5) {
		if (!this.wiresProvidePower) {
			...
			boolean var6 = isPoweredOrRepeater(var1, var2 - 1, var3, var4, 1)
					|| !var1.isBlockNormalCube(var2 - 1, var3, var4) && isPoweredOrRepeater(var1, var2 - 1, var3 - 1, var4, -1);
			boolean var7 = isPoweredOrRepeater(var1, var2 + 1, var3, var4, 3)
					|| !var1.isBlockNormalCube(var2 + 1, var3, var4) && isPoweredOrRepeater(var1, var2 + 1, var3 - 1, var4, -1);
			boolean var8 = isPoweredOrRepeater(var1, var2, var3, var4 - 1, 2)
					|| !var1.isBlockNormalCube(var2, var3, var4 - 1) && isPoweredOrRepeater(var1, var2, var3 - 1, var4 - 1, -1);
			boolean var9 = isPoweredOrRepeater(var1, var2, var3, var4 + 1, 0)
					|| !var1.isBlockNormalCube(var2, var3, var4 + 1) && isPoweredOrRepeater(var1, var2, var3 - 1, var4 + 1, -1);
